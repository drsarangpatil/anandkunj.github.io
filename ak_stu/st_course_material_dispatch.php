...
<title>Course Material Dispatch</title>

</head>
<body>

<script src="js/myjs/get_st_course_material_dispatch.js"></script>
...
<script>    
    function printRepo()
    {
        url ="";
        url=document.URL;
        url=url.replace("st_course_material_dispatch.php", "reports/St_course_material_register.php");
        //alert (url)
        window.open(url);
...
function stDuration(){
    ...
    calculateSTDur();
        ...
        <form action="database/St_course_material_dispatch.php" method="post">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Course Material Dispatch</b></h4>
...
<!-- Course Material Dispatch Pannel Start================================================== -->
 ...
 <!-- Other Information Pannel End================================================== -->
                    ...
                    <div class="form-group col-sm-3">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="st_course_material_dispatch_up.php">Edit Dispatch</a>
                         </div>
                    </div>
				</div>
