...
<title>Add ST Payment</title>

</head>
<body>

<script src="js/myjs/get_st_course_name.js"></script>
<script src="js/myjs/get_st_payment_ad.js"></script>
...
<script>    
    function printRepo_a()
    {
        url ="";
        url=document.URL;
        url=url.replace("st_payment_ad.php", "reports/St_payment_report.php");
        //alert (url)
        window.open(url);
    ...
    <form action="database/St_payment_ad.php" method="post">
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Add ST Payment</b></h4>
...
<!-- Fetched ST Payment Records Pannel starts ================================== -->
                <div class="panel-group">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            All ST Payment Records 
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="form-group col-sm-2">
                                <label>ST Payment ID:</label>
                                <div class="form-group" >
                                    <input type="number" class="form-control"
                                       id="st_payment_id" name="st_payment_id">
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label> &nbsp;</label>
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <div class="form-group">
                                <input type="text" class="form-control" 
                                   id="st_billing_id" name="st_billing_id" readonly>
                            </div>
                        </div>
                        </div>
                    </div>
...
<!-- Fetched ST Payment Records Records Pannel Ends================================= -->
