...
function addition()
{
    ...
    <form action="database/St_billing.php" method="post">
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Course Billing</b></h4>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="form-group">
                                <input type="date" class="form-control" onchange="calculateSTDur()" 
                                       id="doa" name="st_bill_date" readonly>
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
...
<!--Details of OP Charges Pannel ends-->
               <div class="form-group col-sm-8">
                ...
                <div class="form-group col-sm-4">
                    <div class="form-group" >
                        <a class="btn btn-info pull-right" href="st_billing_up.php">Edit Bill</a>
                     </div>
                </div>
			</div>
