...
<title>Course Application From</title>
...
<script src="js/myjs/get_st_course_application_from.js"></script>
...
<script>    
    function printRepo()
    {
        url ="";
        url=document.URL;
        url=url.replace("st_course_application_from.php", "reports/St_student_register.php");
        //alert (url)
        window.open(url);
...
<!--<script>
 function calculateRTDur(){
        ...
        <form action="database/St_course_application_from.php" method="post">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Course Application From </b></h4>
...
<!-- Occupational Background Pannel end================================================ -->
                    ...
                    <div class="form-group col-sm-3">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="st_course_application_from_up.php">Edit Application From</a>
                         </div>
                    </div>
				</div></div></div>
