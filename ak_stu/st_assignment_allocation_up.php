...
<title>Update-Course Assignment Allocation</title>

</head>
<body>

<script src="js/myjs/get_st_assignment_allocation_up.js"></script>
...
<script>    
    function printRepo()
    {
        url ="";
        url=document.URL;
        url=url.replace("St_assignment_allocation_up.php", "reports/Rt_st_register.php");
        //alert (url)
        window.open(url);
        ...
        <form action="database/St_assignment_allocation_up.php" method="post">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Update - Course Assignment Allocation</b></h4>
...
<!-- Fetched Records Pannel starts ================================================== -->
        <div class="panel-group">
            <div class="panel panel-primary">
                <div class="panel-heading">
                All Assignment Allocation Records 
                </div>
                <div class="panel-body">
...
<!-- Course Assignment Allocation Pannel Start================================================== -->
 ...
 <!-- Other Information Pannel End================================================== -->
                    ...
                    <div class="form-group col-sm-3">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="st_assignment_allocation.php">Add Assignment</a>
                         </div>
                    </div>
				</div>
