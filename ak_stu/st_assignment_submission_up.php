...
<title>Update-Course Assignment Submission</title>

</head>
<body>

<script src="js/myjs/get_st_assignment_submission_up.js"></script>
...
<script>    
    function printRepo()
    {
        url ="";
        url=document.URL;
        url=url.replace("st_assignment_submission_up.php", "reports/Rt_st_register.php");
        //alert (url)
        window.open(url);
        ...
        <form action="database/St_assignment_submission_up.php" method="post">
             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Update - Course Assignment Submission</b></h4>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table width="100%" class="table table-striped table-bordered table-hover"      id="dataTables-example">
                            ...
                            <tbody id="course_submission_records">	
                            </tbody>
                        </table>
                         <div class="form-group col-sm-2">
                            <label>CAS ID:</label>
                            <div class="form-group" >
                                <input type="number" class="form-control"
                                   id="st_assignment_submission_id" name="st_assignment_submission_id">
                            </div>
                        </div>
                        <div class="form-group col-sm-2">
                            <label> &nbsp;</label>
...
<!-- Course Assignment Submission Pannel Start===================================== -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control" rows="3" id="assignment_submitted" name="assignment_submitted" required placeholder="Submitted Assignment Details" ></textarea>
                        </div>
                    </div>
                </div>
            </div>
 <!-- Other Information Pannel End================================================== -->
                    ...
                    <div class="form-group col-sm-3">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="st_assignment_submission.php">Add Submision</a>
                         </div>
                    </div>
				</div>
