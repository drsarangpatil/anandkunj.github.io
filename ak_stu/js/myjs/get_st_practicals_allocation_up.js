 $(document).ready
        (
            ...
            {	
                ...
                (
                    {
                        url: 'database/ajax/Get_st_practicals_allocation_up.php',	
                        type: 'GET',								
                                            ...
                                            (
                                                {
                                                    url: 'database/ajax/Get_st_practicals_allocation_up.php',
                                                    type: 'GET',							
                                                    data: { process: "getAll_praticals_allocation_records", st_course_application_id:res_a[0]},

                                                    success: function (data) 
                                                    {
                                                        //alert("Success : " + data);

                                                        $("#course_practicals_records").html(data);
...
function myshow()
        {
            ...
            var st_practicals_allocation_id = $('#st_practicals_allocation_id').val();
            
            //alert(st_practicals_allocation_id);
            ...
            (
                {
                    url: 'database/ajax/Get_st_practicals_allocation_up.php',
                    type: 'GET',							     
                    data: { process: "getSelected_practicals_allocation_data", st_practicals_allocation_id:st_practicals_allocation_id},
                    ...
                    success: function (data) 
                    {
                        ...
                        $("#d_allo_pra").val(res[0]);
                        $("#mode_communi").val(res[1]);
                        $("#practical_name").val(res[2]);
                        $("#course_practicals").val(res[3]);
                    },
