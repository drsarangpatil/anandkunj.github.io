 $(document).ready
        (
            ...
            {	
                ...
                (
                    {
                        url: 'database/ajax/Get_st_assignment_submission.php',	
                        type: 'GET',								
            ...
            (
                {
                    url: 'database/ajax/Get_st_assignment_submission.php',
                    type: 'GET',							
                    data: { process: "getAssignment_allocation_details", st_assignment_allocation_id:st_assignment_allocation_id},
                    ...
                    success: function (data) 
                    {
                        ...
                        $("#d_allo").val(res_a[0]);
                        $("#assignment_name").val(res_a[1]);
                        $("#course_assignment").val(res_a[2]);
