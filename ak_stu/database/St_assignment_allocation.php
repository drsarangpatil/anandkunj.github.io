<?php
	...
	if ($con)
	{
		...
		{  
			//create  insert query
           $query1= "INSERT INTO ak_st_assignment_allocation (person_id, st_course_application_id, user_id, d_allo, assignment_language, mode_communi, assignment_name, course_assignment) VALUES ('". $_POST["person_id"]."', '". $_POST["st_course_application_id"]."', '". $_POST["user_id"]."', '". $_POST["d_allo"]."', '". $_POST["assignment_language"]."', '". $_POST["mode_communi"]."', '". $_POST["assignment_name"]."', '". $_POST["course_assignment"]."')";
