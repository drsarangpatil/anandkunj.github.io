<?php
	...
	if ($con)
	{
        ...
        if($process === "getAll_assignment_allocation_records")
		{
         ...
         if($process === "getAssignment_allocation_details")
		{
			$st_assignment_allocation_id=filter_input(INPUT_GET, 'st_assignment_allocation_id');
            
			//echo "6";
            
			$query = ("SELECT d_allo, assignment_name, course_assignment FROM ak_st_assignment_allocation WHERE st_assignment_allocation_id = '" . $st_assignment_allocation_id . "'");
