<?php
	...
	if ($con)
	{
        ...
        if($process === "getAll_billing_records")
		{
            ...
            $query = ("SELECT st_billing_id, payable_amount, st_course_application_id, st_bill_date, user_id  FROM ak_st_billing WHERE payment_status ='Due' and st_course_application_id = '" . $st_course_application_id ."'");
