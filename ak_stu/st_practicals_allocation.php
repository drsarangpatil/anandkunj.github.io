...
<title>Course Practicals Allocation</title>

</head>
<body>

<script src="js/myjs/get_st_practicals_allocation.js"></script>
...
<script>    
    function printRepo()
    {
        url ="";
        url=document.URL;
        url=url.replace("st_practicals_allocation.php", "reports/Rt_st_register.php");
        //alert (url)
        window.open(url);
        ...
        <form action="database/St_practicals_allocation.php" method="post">
           <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Course Practicals Allocation</b></h4>
