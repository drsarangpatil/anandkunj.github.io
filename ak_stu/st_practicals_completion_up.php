...
<title>Update-Course Practicals Completion</title>

</head>
<body>

<script src="js/myjs/get_st_practicals_completion_up.js"></script>
...
<script>    
    function printRepo()
    {
        url ="";
        url=document.URL;
        url=url.replace("st_practicals_completion_up.php", "reports/Rt_st_register.php");
        //alert (url)
        window.open(url);
        ...
        <form action="database/St_practicals_completion_up.php" method="post">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Update - Course Practicals Completion</b></h4>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table width="100%" class="table table-striped table-bordered table-hover"      id="dataTables-example">
                            ...
                            <tbody id="course_completion_records">	
                            </tbody>
                        </table>
                         <div class="form-group col-sm-2">
                            <label>CAS ID:</label>
                            <div class="form-group" >
                                <input type="number" class="form-control"
                                   id="st_practicals_completion_id" name="st_practicals_completion_id">
                            </div>
                        </div>
                        <div class="form-group col-sm-2">
                            <label> &nbsp;</label>
...
<!-- Course Assignment Submission Pannel Start================================================== -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control" rows="3" id="practicals_completed" name="practicals_completed" required placeholder="Completed Practicals" ></textarea>
                        </div>
                    </div>
                </div>
            </div>
 <!-- Other Information Pannel End================================================== -->
                    ...
                    <div class="form-group col-sm-4">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="st_practicals_completion.php">Add Practicals Completion</a>
                         </div>
                    </div>
				</div>
