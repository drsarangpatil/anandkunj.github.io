...
<title>Update-Course Practicals Allocation</title>

</head>
<body>

<script src="js/myjs/get_st_practicals_allocation_up.js"></script>
...
<script>    
    function printRepo()
    {
        url ="";
        url=document.URL;
        url=url.replace("st_practicals_allocation_up.php", "reports/Rt_st_register.php");
        //alert (url)
        window.open(url);
        ...
        <form action="database/St_practicals_allocation_up.php" method="post">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Upadte - Course Practicals Allocation</b></h4>
...
<!-- Course Practicals Allocation Pannel Start================================================== -->
                    
					<div class="panel-group">
                    <div class="panel panel-primary">

                    <div class="panel-heading">
                        Course Practicals Allocation Details
                    </div>	
                    <div class="panel-body">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="form-group">
                                <input type="date" class="form-control" 
                                id="d_allo_pra" name="d_allo_pra" required>
                            </div>
                        </div>
                       <!-- <div class="form-group col-sm-4">
                            <label>Language:</label>
                            <div class="form-group">
                                 <select class="form-control" 
                                    id="practicals_language" name="practicals_language" required>
                                <option></option>
                                <option>Marathi</option>
                                <option>Hindi</option>
                                <option>English</option>
                        ...
                        <div class="form-group col-sm-12">
                            <label>Details of Allocated Practical Training:</label>
                            <textarea class="form-control" rows="3" id="course_practicals" name="course_practicals" required placeholder="Practical Details" ></textarea>
                        </div>
                    </div>
                </div>
            </div>
 <!-- Other Information Pannel End================================================== -->
                    ...
                    <div class="form-group col-sm-3">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="st_practicals_allocation_up.php">Edit Practicals</a>
                         </div>
                    </div>
				</div>
