                ...
                <?php 
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            $qryPr="SELECT p.full_name, p.dob, p.at_post, p.mobile_no, c.st_course_application_id, y.st_payment_id, y.st_payment_date, y.payable_amount, y.amount_paid, y.balance_amount, y.payment_mode, y.payment_details, y.st_billing_id, c.course_name, c.doa, c.doc, y.pan_name, y.pan_number, p.email FROM ak_p_registration p, ak_st_course_application c, ak_st_payment y WHERE p.person_id= c.person_id  and c.st_course_application_id= y.st_course_application_id";
                            $qryPr=$qryPr . " and y.st_payment_id = ". $_GET["pyid"];
...
<!-- Document Header End ================================================== -->
    ...
    <p align="right"><span>Receipt No.:</span> <span> <?php echo $year;?>/0<?php echo $recordPr[5];?> </span>, <span>ST ID:</span> <span> <?php echo $recordPr[4];?></span></p>
        <!--//-$month-$recordPr[5]-->
