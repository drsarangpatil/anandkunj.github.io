...
<html lang="en">
    <head>
        <title>Retreat Followup Reminder SMS</title>
        <meta charset="utf-8">
...
<!-- Document Header Start =================================== -->
    ...
    <h4 align="center"><b> Retreat Followup Reminder SMS </b> </h4>
...
<!-- Form Information ================================================== -->
                    ...
                    <div class="panel-heading">
                        Retreat Followup Reminder SMS
                    </div>
                    <div class="panel-body">
                        <div class="form-group col-sm-12">
                            <label>SMS to be Sent:</label>
                            <div class="form-group">
                                <textarea class="form-control" cols="90" rows="3" id="op_sms_template" name="op_sms_template">You finished Shivambu Retreat on <?php echo $recordPr[6];?>. Your next appointment visit or followup-contact is fixed on <?php echo $followup_date;?>, ANANDKUNJ: 9404135010</textarea>
                            </div>
                        </div>
				    </div>
                </div>
...
<?php
   ...
   // echo $recordPr[1];
    $message = ">You finished Shivambu Retreat on $recordPr[6]. Your next appointment visit or followup-contact is fixed on $followup_date, ANANDKUNJ: 9404135010";
