...
<title>Assignment Submission Register</title>
...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "St_assignment_submission_register.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("St_assignment_submission_register.php", "print/St_assignment_submission_register_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JS script for Aprint button=========>         
        function aprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("St_assignment_submission_register.php", "print/St_address_labels_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JQ script for AJAX Call Ends =========>
        ...
        <form action="" method="POST" class="form-inline" >
             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b>Assignment Submission Register</b></h4>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> Assignment Submission Register</b></h5><p style= "color:slateBlue"> For Donation Receipt Print Ctrl+Click <span style= "color:orange"> Full Name</span>  For Donation Acknowledgement Email Ctrl+Click <span style= "color:orange">At Post</span><br> For Donation Acknowledgement SMS Ctrl+Click <span style= "color:orange">Mobile No</span>  </p>
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT s.st_assignment_submission_id, c.doa, c.doc, c.course_name, s.assignment_name, s.d_allo, s.d_submi, s.checked_by, s.grade_secu, p.photo, p.full_name, p.at_post, p.mobile_no, c.ad_status FROM ak_p_registration p, ak_st_course_application c,  ak_st_assignment_submission s WHERE p.person_id= c.person_id and c.st_course_application_id = s.st_course_application_id";
...
<!-- Php code for RT Case Sheet Table Ends =============================== -->
                    ...
                    <td><a href="../st_assignment_submission.php">Go to Menu</a></td>
                    </div>
                    </div>
                </div>
            </div>
