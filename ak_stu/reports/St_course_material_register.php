...
<title>Course Material Register</title>
...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "St_course_material_register.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("St_course_material_register.php", "print/St_course_material_register_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JS script for Aprint button=========>         
        function aprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("St_student_register.php", "print/St_address_labels_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JQ script for AJAX Call Ends =========>
        ...
        <form action="" method="POST" class="form-inline" >
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> Course Material Dispatch Register</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    Course Material Register
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> Course Material Dispatch Registe</b></h5><p style= "color:slateBlue"> For Donation Receipt Print Ctrl+Click <span style= "color:orange"> Full Name</span>  For Donation Acknowledgement Email Ctrl+Click <span style= "color:orange">At Post</span><br> For Donation Acknowledgement SMS Ctrl+Click <span style= "color:orange">Mobile No</span>  </p>
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT s.st_course_material_id, c.doa, c.doc, c.course_name, s.material_language, s.mode_dispatch, s.dod, p.photo, p.full_name, p.at_post, p.mobile_no, c.ad_status, s.st_course_application_id  FROM ak_p_registration p, ak_st_course_application c, ak_st_course_material_dispatch s WHERE p.person_id= c.person_id and c.st_course_application_id = s.st_course_application_id";
                                       ...
                                       /*$i =1;*/
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="left">
                                                <a href= "print/St_cm_dispatch_alert_email.php?stid=' .$record[12] . '">' . $record[8] . '</a> </td>';
...
<!-- Php code for RT Case Sheet Table Ends =============================== -->
                    ...
                    <td><a href="../st_course_material_dispatch.php">Go to Menu</a></td>
                    </div>
                    </div>
                </div>
            </div>
