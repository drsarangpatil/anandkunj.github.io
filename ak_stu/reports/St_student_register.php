...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "St_student_register.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("St_student_register.php", "print/St_student_register_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> Student Register</b></h5><p style= "color:slateBlue"> For Donation Receipt Print Ctrl+Click <span style= "color:orange"> Full Name</span>  For Donation Acknowledgement Email Ctrl+Click <span style= "color:orange">At Post</span><br> For Donation Acknowledgement SMS Ctrl+Click <span style= "color:orange">Mobile No</span>  </p>
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT c.st_course_application_id, c.doa, c.course_duration, c.doc, c.course_name, c.course_language, p.photo, p.full_name, p.email, p.at_post, p.mobile_no, c.ad_status FROM ak_p_registration p, ak_st_course_application c WHERE p.person_id= c.person_id ";
                                       ...
                                       /*$i =1;*/
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="left">
                                                <a href= "print/St_welcome_email.php?stid=' .$record[0] . '">' . $record[4] . '</a> </td>';
                                                echo '<td align="left">' . $record[5] . '</td>';
                                                echo '<td align="left"><img width="30" height="40" class="img-rounded" src="../../ak_com/database/photos/'. $record[6] .'">  </td>';
...
<!-- Php code for RT Case Sheet Table Ends =============================== -->
                    ...
                    <td><a href="../st_course_application_from.php">Go to Menu</a></td>
                    </div>
                    </div>
                </div>
                </div>
