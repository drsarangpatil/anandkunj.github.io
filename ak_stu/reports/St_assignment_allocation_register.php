...
<title>Assignment Allocation Register</title>
...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "St_assignment_allocation_register.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("St_assignment_allocation_register.php", "print/St_assignment_allocation_register_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JS script for Aprint button=========>         
        function aprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("St_assignment_allocation_register.php", "print/St_address_labels_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JQ script for AJAX Call Ends =========>
        ...
        <form action="" method="POST" class="form-inline" >
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b>Assignment Allocation Register</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    Assignment Allocation Register
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> Assignment Allocation Register</b></h5><p style= "color:slateBlue"> For Donation Receipt Print Ctrl+Click <span style= "color:orange"> Full Name</span>  For Donation Acknowledgement Email Ctrl+Click <span style= "color:orange">At Post</span><br> For Donation Acknowledgement SMS Ctrl+Click <span style= "color:orange">Mobile No</span>  </p>
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT s.st_assignment_allocation_id, c.doa, c.doc, c.course_name, s.assignment_name, s.assignment_language,  s.d_allo, s.mode_communi, p.photo, p.full_name, p.at_post, p.mobile_no, c.ad_status FROM ak_p_registration p, ak_st_course_application c, ak_st_assignment_allocation s WHERE p.person_id= c.person_id and c.st_course_application_id = s.st_course_application_id";


                                        if( isset($_GET["from_date"]))
                                           if( $_GET["from_date"]!==""  &&  $_GET["to_date"]!=="" )
                                            {
                                                $query = $query .   " and  ( s.d_allo between '".  $_GET["from_date"] . "' and '".  $_GET["to_date"] . "')"; 
                                            }
                                       ...
                                       /*$i =1;*/
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="left"><img width="30" height="40" class="img-rounded" src="../../ak_com/database/photos/'. $record[8] .'">  </td>';
...
<!-- Php code for RT Case Sheet Table Ends =============================== -->
                    ...
                    <td><a href="../st_assignment_allocation.php">Go to Menu</a></td>
                    </div>
                    </div>
                </div>
            </div>
