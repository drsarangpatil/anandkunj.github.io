...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "St_payment_report.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            ...
            url=document.URL;
            url=url.replace("St_payment_report.php", "print/St_payment_report_print.php");
            //alert (url)
            window.open(url);
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> ST Payment Report</b></h5><p style= "color:slateBlue"> For ST Receipt Print Ctrl+Click <span style= "color:orange"> Full Name</span></p>
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT y.st_payment_id, y.st_payment_date, p.photo, p.full_name, p.at_post, p.mobile_no,  c.course_name, y.payable_amount, y.amount_paid, y.balance_amount, y.payment_mode, y.payment_status FROM ak_p_registration p, ak_st_course_application c, ak_st_payment y WHERE p.person_id= c.person_id  and c.st_course_application_id= y.st_course_application_id";


                                        if( isset($_GET["from_date"]))
                                           if( $_GET["from_date"]!==""  &&  $_GET["to_date"]!=="" )
                                            {
                                                $query = $query .   " and  (y.st_payment_date between '".  $_GET["from_date"] . "' and '".  $_GET["to_date"] . "')"; 
                                            }
                                       ...
                                       //echo $query;
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="left"><a href= "print/St_receipt_print.php?pyid=' .$record[0] . '">' . $record[3] . '</a></td>';
                                           ...
                                           // $i = $i+1;
                                            ...
                                            echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                echo '<td colspan="8" style="font-weight: bold" align="right">Total Collection</td>';
...
<!-- Php code for RT Case Sheet Table Ends =============================== -->
                    ...
                    <td><a href="../st_payment.php">Go to Menu</a></td>
                    </div>
                    </div>
                </div>
            </div>
