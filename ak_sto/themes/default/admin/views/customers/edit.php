            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group person">
                        <?= lang("name", "name"); ?>
                        <?php echo form_input('name', $customer->name, 'class="form-control tip" id="name" '); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("vat_no", "vat_no"); ?>
                    ...
                    <div class="form-group">
                        ...
                        if ($this->Settings->indian_gst) {
                            ...
                            echo form_input('state', $customer->state, 'class="form-control" id="state"required="required"');
                        }
                        ?>
                    </div>
