...
// JS script for display button=========>
        function dispRepo()
        {
            ...
            url += "Op_visit_register.php?gender=" + document.getElementById("gender").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Op_visit_register.php", "print/Op_visit_register_print.php");
            //alert (url)
            window.open(url);
                        ...
                        <!--<div class="form-group col-sm-4">
                         ...
                         <div class="form-group col-sm-3 pull-right">
                            ...
                            <div class="form-group" >
                                ...
                                <button type="button" class="btn btn-primary" onclick="printRepo()"> <span class="glyphicon glyphicon-print"></span>  Vz Register</button>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                            echo '<tr class="odd gradeX" style="font-size:13px" >';
                                               ...
                                               /*echo '<td align="left">' . $record[7] . '</td>';*/
                                                ...
                                                echo '<td align="left">
                                                <a href= "print/Op_medicine_prescription_print.php?vsid=' .$record[3] . '">' . nl2br($MdNm) . '</a> </td>';
                                               ...
                                               $qryLs="SELECT life_style_instructions FROM  ak_op_lifestyle_prescription WHERE op_visit_id ='" . $record[3] ."' and visit_date= '" . $record[4] ."' and schedule= '" . $record[5] ."' ";
                                                ...
                                                echo '<td align="left">
                                                <a href= "print/Op_ls_prescription_print.php?vsid=' .$record[3] . '">' . nl2br($Ls) . '</a> </td>';
