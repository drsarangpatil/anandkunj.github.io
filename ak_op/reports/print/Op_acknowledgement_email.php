...
<!-- Document Header Start =================================== -->
    ...
    <h4 align="center"><b> OP Welcome Email </b> </h4>
    <p align="center"><span>Full Name:</span> <span> <?php echo $recordPr[0];?></span>, <span>Email Id:</span> <span> <?php echo $recordPr[11];?></span>, <span>OP ID:</span> <span> <?php echo $recordPr[3];?></span></p>
<!-- Form Information ================================================== -->
                    ...
                    <div class="panel-body">    
                        <div class="form-group col-sm-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" cols="90" rows="1" id="email_subject" name="email_subject"> OP Welcome </textarea>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">                        
...
किसी भी प्रश्न के लिए, 9404135010 इस नंबर पर कार्यालयीन समय के दौरान संपर्क करने में संकोच न करें (सुबह 10.00  से शाम 6.00 बजे तक)। आपकी अगली भेंट <?php echo $followup_date;?> तारीख पर निर्धारित की गयी है।  
...
$mail->Subject = 'Welcome to Shivambu Bhavan';
...
<h2>स्वास्थ्य की राह पर स्वागत</h2><br><br>
...
हम आपको अनुरोध करते हैं की, आपके लिए जो दवाईयां, उपचार कार्यक्रम और जीवन शैली में परिवर्तन सुझाए गए है उनका पालन घर पर आप ख़ुशी और निष्ठा से करें। कृपया ध्यान दें कि, आपका स्वास्थ्य आपके हाथों में है। <br><br> 
    
किसी भी प्रश्न के लिए, 9404135010 इस नंबर पर कार्यालयीन समय के दौरान संपर्क करने में संकोच न करें (सुबह 10.00  से शाम 6.00 बजे तक)। आपकी अगली भेंट $followup_date तारीख पर निर्धारित की गयी है। <br><br> 
