...
<!-- Prescription Panel Starts================================== -->
            <div class="table-responsive">
                <table width="100%" class="table table-striped table-bordered table-hover"                      id="cs_table">
                        ...
                        <tr>
                            <th>Complaints:</th>
                            <td colspan="5"><?php echo $recordPr[7];?></td>
                        </tr>
                        <tr>
                            <th colspan="1">O/E:</th> 
                            <td colspan="2"><?php echo $recordPr[10];?></td>
                            <th colspan="1">BP:</th> 
                            <td colspan="2"><?php echo $recordPr[9];?> mmHg</td>
                        </tr>
                </table>
            </div>
                <div class="table-responsive">
...
<!-- Php code for OP Medicine Starts =============================== -->
                         <?php 
                                ...
                                {
                                    {
                                        $query="SELECT medicine_names FROM  ak_op_medicine_prescription WHERE op_visit_id ='" . $recordPr[4] ."'";
