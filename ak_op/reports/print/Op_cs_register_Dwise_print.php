<html lang="en">
    <head>
        <title>Disease-wise OP Case Sheet </title>
        <meta charset="utf-8">
...
<!-- Document Header End ================================================== --> 
                <h5 align="center"><b> Disease-wise OP Case Sheet Register</b></h5>
                                       ...
                                       $query="SELECT c.final_diagnosis, p.photo, p.full_name, p.gender, p.dob, p.address, p.at_post, p.mobile_no, c.op_case_sheet_id, c.case_paper_date, c.user_id FROM ak_p_registration p, ak_op_case_sheet c WHERE p.person_id= c.person_id";
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="center">' . $diff->y . '</td>';
                                               
                                                echo '<td style="font-size:12px" align="center">' . $record[5] . '</td>';
...
<!-- Php code for OP Case Sheet Table Ends =============================== -->
                    ...
                    <!--<td><a href="../op_cs_register_Dwise.php">Back</a></td>-->
                    </div>
                </div>
