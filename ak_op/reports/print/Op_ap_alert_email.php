...
<html lang="en">
    <head>
        <title>OP Appointment Alert Email</title>
        <meta charset="utf-8">
                ...
                <?php 
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            $qryPr="SELECT ap_date, ap_session, ap_time, ap_type, ap_with, ap_purpose, ap_status, full_name, age, gender, at_post, mobile_no, email, op_ap_id FROM ak_op_appointment WHERE op_ap_id = ". $_GET["apid"];
...
<!-- Document Header Start =================================== -->
    ...
    <h4 align="center"><b> OP Appointment Alert Email </b> </h4>
    <p align="center"><span>Full Name:</span> <span> <?php echo $recordPr[7];?></span>, <span>Email Id:</span> <span> <?php echo $recordPr[12];?></span>, <span>AP ID:</span> <span> <?php echo $recordPr[13];?></span></p>
<!-- Form Information ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
                        OP Appointment Alert Email
                    </div>
<!-- Email Header Start =================================== -->   
                    ...
                    <div class="panel-body">    
                        <div class="form-group col-sm-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" cols="90" rows="1" id="email_subject" name="email_subject"> OP Appointment Alert </textarea>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">                        
...
आपके अनुरोध के अनुसार, हमने आपकी <?php echo $recordPr[4];?> जी के साथ, तारीख <?php echo $recordPr[0];?> को <?php echo $recordPr[1];?> सत्र में <?php echo $recordPr[2];?> बजे, अपॉइंटमेंट तय की है । कृपया उपरोत समय पर उपस्थित रहकर सेवा का लाभ जरुर लें.
    
किसी भी प्रश्न के लिए, 9404135010 इस नंबर पर कार्यालयीन समय के दौरान संपर्क करने में संकोच न करें (सुबह 10.00  से शाम 6.00 बजे तक)। 
...
$mail->addAddress($recordPr[12], $recordPr[0]);

//Set the subject line
$mail->Subject = 'Consultation Appointment - Alert';
...
<hr>
<h3>अपॉइंटमेंट पूर्वसूचना - Alert</h3><br><br>
...
आपके अनुरोध के अनुसार, हमने आपकी $recordPr[4] जी के साथ, तारीख $recordPr[0] को $recordPr[1] सत्र में $recordPr[2] बजे, अपॉइंटमेंट तय की है । <br>
कृपया उपरोक्त समय पर उपस्थित रहकर सेवा का लाभ जरुर लें। <br><br> 
...
$mail->AltBody = "This is a OP Appointment Alert Email";
...
if (!$mail->send()) {
    ...
    echo "OP Appointment Alert Email Sent to $recordPr[7] ! <br>" ;
    //Section 2: IMAP
