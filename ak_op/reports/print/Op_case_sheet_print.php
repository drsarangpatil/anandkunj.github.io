                ...
                <?php 
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            $qryPr="SELECT c.op_case_sheet_id, p.photo, p.full_name, c.case_paper_date, p.occupation, p.dob, p.gender, p.marital_status, p.male_child, p.female_child, p.email, p.mobile_no, p.at_post,  p.address FROM ak_p_registration p, ak_op_case_sheet c WHERE p.person_id= c.person_id ";
                            ...
                            $qryCs="SELECT present_complaints, past_history, clinical_history, final_diagnosis FROM ak_op_case_sheet WHERE op_case_sheet_id='" . $recordPr[0] ."' ";
                           ...
                           // echo $qryCs;
                            ...
                            /*$qryDis="SELECT disease_name, disease_nick FROM ak_op_case_sheet_fd WHERE op_case_sheet_id='" . $recordPr[0] ."' ";
...
<!-- Document Header End ================================================== -->
    <h4 align="center"><b> OP Case-Sheet</b> </h4>
    <p align="center"><span style="font-family:IDAutomationHC39S; font-size:8px;"> <?php echo $recordPr[2];?> </span> CS ID: <span style="font-family:IDAutomationHC39S; font-size:8px;"> <?php echo $cs_no;?> </span></p>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" 
                        ...
                        <tr>
                            <td width="15%" align="left">
                                ...
                                <img id="photo" name="photo" class="img-rounded"  width="97" height="141" src="../../../ak_com/database/photos/<?php echo $recordPr[1];?>"  alt="Image not uploded">
                                </a>
                            ...
                            <td width="85%" align="left">
                                <table width="100%" class="table table-striped table-bordered table-        hover" id="cs_table">
                                    <tr>
                                        ...
                                        <th>Date:</th> <td colspan="3"><?php echo $recordPr[3];?></td>
                                        <!--<th>Dis Date:</th> <td>--</td>-->
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th >Mr Status:</th> <td><?php echo $recordPr[7];?></td>
                                        <th >Mobile:</th> <td colspan="3"><?php echo $recordPr[11];?></td>
                                        <!--<th >Female Child:</th> <td><?php echo $recordPr[9];?></td>-->
                                    </tr>
                                    <tr>
                                        <th >Email ID.:</th> <td><?php echo $recordPr[10];?></td>
                                        <th >Address:</th> <td colspan="3"><?php echo $recordPr[13];?></td>
