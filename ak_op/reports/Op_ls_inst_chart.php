...
<title>Op Life Style Instructions Chart</title>
...
// JS script for display button=========>
        function dispRepo()
        {
            ...
            url += "Op_ls_inst_chart.php?gender=" + document.getElementById("gender").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Op_ls_inst_chart.php", "print/Op_ls_inst_chart_print.php");
            //alert (url)
            window.open(url);
...
// JQ script for AJAX Call Ends =========>                   
        ...
        <form action="" method="POST" class="form-inline">
             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> Op Life Style Instructions Chart</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">

                    <div class="panel-heading">
				    Op Life Style Instructions Chart
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> Op Life Style Instructions</b></h5><p style= "color:slateBlue"> For OP Life Style Instructions Print Ctrl+Click Full Name </p>
                                    ...
                                    else
                                    {
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="left"><a href= "print/Op_ls_prescription_print.php?vsid=' .$record[3] . '">' . $record[0] . '</a></td>';
