...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "Op_payment_report.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            ...
            url=document.URL;
            url=url.replace("Op_payment_report.php", "print/Op_payment_report_print.php");
            //alert (url)
            window.open(url);
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> OP Payment Report</b></h5><p style= "color:slateBlue"> For OP Receipt Print Ctrl+Click Full Name </p>
...
<!-- Php code for OP Case Sheet Table Ends =============================== -->
                    ...
                    <td><a href="../op_payment.php">Go to Menu</a></td>
                    </div>
                    </div>
                </div>
                </div>
