...
{	
    ...
    (
        {
            url: 'database/ajax/Get_op_treatment_diet_up.php',	// call page for data to be retrived
    ...
    ( 
        function() 
        {
            ...
            (
                {
                    url: 'database/ajax/Get_op_treatment_diet_up.php',
                    type: 'GET',							
            ...
            (
                {
                    url: 'database/ajax/Get_op_treatment_diet_up.php',
                    type: 'GET',							
                    data: { process: "getSelected_treatment_prescription_data", op_visit_id:op_visit_id },
            ...
            (
                {
                    url: 'database/ajax/Get_op_treatment_diet_up.php',
                    type: 'GET',							
                    data: { process: "getSelected_diet_prescription_data", op_visit_id:op_visit_id },
