...
<title>Update - OP Case Sheet</title>
...
<script src="js/myjs/get_op_case_sheet_up.js"></script>
...
<script>    
    function printRepo()
    {
        url ="";
        url=document.URL;
        url=url.replace("op_case_sheet_up.php", "reports/Op_cs_register.php");
        //alert (url)
        window.open(url);
        ...
        <form action="database/Op_case_sheet_up.php" method="post">
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Update - OP Case Sheet</b></h4>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="form-group" >
                                <input type="number" class="form-control"
                                id="op_case_sheet_id" name="op_case_sheet_id">
                            </div>
                        </div>
                        <div class="form-group col-sm-8">
                            <label> &nbsp;</label>
                        ...
                        <div class="form-group col-sm-3">
                            ...
                            <div class="form-group">
                                <input type="date" class="form-control" 
                                       id="case_paper_date" name="case_paper_date">
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
...
<!-- Final Diagnosis Pannel end ================================================== -->						
                        ...
                        <div class="form-group col-sm-2">
                            <div class="form-group" >
                                <a class="btn btn-info pull-right" href="op_case_sheet.php">Add OP Case-Sheet</a>
                             </div>
                        </div>
				    </div>
