...
<title>OP Appointment Rescheduling, Completion </title>
...
<script>    
    function printRepo_a()
    {
        url ="";
        url=document.URL;
        url=url.replace("op_appointment_up.php", "reports/Op_appointment_register.php");
        //alert (url)
        window.open(url);
    ...
    <form action="database/Op_appointment_up.php" method="post">
       <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>OP Appointment Rescheduling and Completion</b></h4>
...
<!--OP Appointment  Info ends========================================= -->
                    ...
                    <div class="form-group col-sm-4">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="op_appointment.php">Add New OP Appointment</a>
                         </div>
                    </div>
			     </div>
