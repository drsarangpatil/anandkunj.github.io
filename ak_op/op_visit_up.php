...
<script>    
    function printRepo_a()
    {
        url ="";
        url=document.URL;
        url=url.replace("op_visit_up.php", "reports/Op_medicine_chart.php");
        //alert (url)
        window.open(url);
     ...
     function printRepo_b()
    {
        url ="";
        url=document.URL;
        url=url.replace("op_visit_up.php", "reports/Op_ls_inst_chart.php");
        //alert (url)
        window.open(url);
    ...
    <form action="database/Op_visit_up.php" method="post">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Update - OP Visit</b></h4>
...
<!-- Life Style Prescription Pannel ends================================================== -->
 ...
 <!-- Nav Tab Bar Pannel end ================================================== -->	
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="op_visit.php">Add Visit</a>
                         </div>
                    </div>
			     </div>
