...
<title>Add OP Payment</title>

</head>
<body>

<script src="js/myjs/get_op_payment_ad.js"></script>
...
<script>    
    function printRepo_a()
    {
        url ="";
        url=document.URL;
        url=url.replace("op_payment_ad.php", "reports/Op_payment_report.php");
        //alert (url)
        window.open(url);
    ...
    <form action="database/Op_payment_ad.php" method="post">
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b> Add OP Payment</b></h4>
                ...
                <div class="panel-group">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-sm-2">
                                <label>OP Payment ID:</label>
                                <div class="form-group" >
                                    <input type="number" class="form-control"
                                       id="op_payment_id" name="op_payment_id">
                                </div>
                            </div>
                            <div class="form-group col-sm-10">
                                <label> &nbsp;</label>
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <div class="form-group">
                                <input type="text" class="form-control" 
                                   id="op_billing_id" name="op_billing_id" readonly>
                            </div>
                        </div>
                        </div>
                    </div>
                            ...
                            <div class="panel-body"> 
                               <div class="form-group col-sm-3">
                                ...
                                <!--<div class="form-group col-sm-2">
                                    <label></label>
                                    <div class="form-group">
                                        <a href="#" id="print_receipt" class="btn btn-success pull-right btn-md"> <span class="glyphicon glyphicon-print">  </span>  Receipt</a>
                                    </div>
                                </div>-->
                            </div>
                        </div>
