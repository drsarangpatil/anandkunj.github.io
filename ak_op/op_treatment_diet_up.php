...
<title>Update - OP Treatment and Diet Prescription</title>
...
<script src="js/myjs/get_op_treatment_diet_up.js"></script>
...
<script>    
    function printRepo_a()
    {
        url ="";
        url=document.URL;
        url=url.replace("op_treatment_diet_up.php", "reports/Op_treat_chart.php");
        //alert (url)
        window.open(url);
     ...
     function printRepo_b()
    {
        url ="";
        url=document.URL;
        url=url.replace("op_treatment_diet_up.php", "reports/Op_diet_chart.php");
        //alert (url)
        window.open(url);
    ...
    <form action="database/Op_treatment_diet_up.php" method="post">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h4><b>Update - OP Treatment and Diet Prescription</b></h4>
							  ...
							  <div class="media">
                                ...
                                <div class="form-group col-sm-12">
                                 ...
                                 <!-- <div class="form-group col-sm-2">
                                    <label>User ID:</label>
                                    <div class="form-group">
                                    readonly<input type="text" class="form-control" id="user_id" name="user_id"<?php echo "value='". $_SESSION['user_id'] ."'";?>readonly>
                                    </div>
                                </div>>-->
                                </div>
                            </div>
...
<!-- Tab OP Diet Prescription Pannel ends================================================== -->
 ...
 <!-- Nav Tab Bar Pannel end ================================================== -->	
                    ...
                    <div class="form-group col-sm-4">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="op_treatment_diet.php">Add Treatment and Diet</a>
                         </div>
                    </div>
			     </div>
