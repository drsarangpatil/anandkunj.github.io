<?php
	...
	if ($con)
	{
        ...
        if($process === "getSelected_medicine_prescription_data")
		{
			...
			$query = ("SELECT medicine_names FROM ak_op_medicine_prescription WHERE op_visit_id = '" . $op_visit_id. "'");
        ...
        if($process === "getSelected_LS_prescription_data")
		{
			...
			$query = ("SELECT life_style_instructions FROM ak_op_lifestyle_prescription WHERE op_visit_id = '" . $op_visit_id. "'");
