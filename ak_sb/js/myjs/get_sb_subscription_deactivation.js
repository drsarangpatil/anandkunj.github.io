$(document).ready
    ...
    {	
                ...
                (
                    {
                        url: 'database/ajax/Get_sb_subscription_deactivation.php',	// call page for data to be retrived
            ...
            (
                {
                    url: 'database/ajax/Get_sb_subscription_deactivation.php',			
                    type: 'GET',								
                    data: { process: "getAll_deactivated_subscription_records" },			

                    success: function (data) 
                    {
                        //alert("Success : " + data);
                        $("#old_deactivated_subscription_records_list").html(data);					
                    },
                    error:function (data) 
                    {
                        alert("Error : " + data);				
