...
<script src="js/myjs/get_sb_subscription_type_up.js"></script>
        ...
        <form action="database/Sb_subscription_type.php" method="post">
             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b>Add Subscription Type </b></h4>
    <!-- Fetched All Subscription Type Records Pannel starts ================================== -->
            <div class="panel-group">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        All Subscription Type Records 
                    </div>
...
<!-- Form Information Pannel Ends================================= -->
              <div class="panel-body">
                ...
                <div class="form-group col-sm-2">
                    <div class="form-group" >
                        <a class="btn btn-info pull-right" href="sb_subscription_type_up.php">Edit Subscription Type</a>
                     </div>
                </div>               
            </div>  
            </div>
