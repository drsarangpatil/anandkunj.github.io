...
<script src="js/myjs/get_sb_subscription_form.js"></script>
...
function subDuration(){
    ...
    calculateSBDur();
        ...
        <form action="database/Sb_subscription_form.php" method="post">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Subscription Form </b></h4>
...
<!-- Fetched Subscription Records Pannel starts ========================================= -->
            <div class="panel-group">
                <div class="panel panel-info">
                    <div class="panel-heading">
                       List of Existing Active Subscriptions of Above Person:
                    </div>
                    <div class="panel-body">
...
<!-- Subscription Information ================================================== -->
                    ...
                    <div class="panel-body">
                        <div class="form-group col-sm-4">
                            <label>Subscription for: Name of Magazine:</label>
                              <div class="form-group">
...
<!-- Subscription Pannel end ================================================== -->
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="sb_subscription_form_up.php">Edit Subscription Form</a>
                         </div>
                    </div>
				</div>
