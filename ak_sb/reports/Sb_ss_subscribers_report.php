...
<title>Shivambu Samachar Subscribers Register</title>
...
// JS script for display button========>       
        ...
        {
            url ="";
            url += "Sb_ss_subscribers_report.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Sb_ss_subscribers_report.php", "print/Sb_ss_subscribers_report_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
        ...
        function aprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Sb_ss_subscribers_report.php", "print/Sb_address_labels_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
        ...
        function bprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Sb_ss_subscribers_report.php", "print/Sb_dispatch_alert_email_bulk.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
        ...
        function cprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Sb_ss_subscribers_report.php", "print/Sb_renewal_request_email_bulk.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JQ script for AJAX Call Ends =========> 
        ...
        <form action="" method="POST" class="form-inline">
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> Shivambu Samachar Subscribers Register</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    Shivambu Samachar Subscribers Register
				    </div>
                    ...
                    <div class="media">
                        ...
                        <div class="form-group col-sm-6 ">
                            <label></label>
                            <div class="form-group" >
                                <button type="button" class="btn btn-primary pull-center"  onclick="bprintRepo()"> Dispatch-At Bulk Email <span class="glyphicon glyphicon-envelope"></span> </button>
                                <button type="button" class="btn btn-primary pull-center"  onclick="cprintRepo()"> Renewal-Rt Bulk Email <span class="glyphicon glyphicon-envelope"></span> </button>
                            </div>
                        </div>
                    </div>
                </div>
<!-- Filters for Sorting Columns Ends ================================================== -->
                 <h5><b> Shivambu Samachar Subscribers Register</b></h5> <p style= "color:slateBlue"> For Dispatch-Alert Email Ctrl+Click Full Name; For Renewal-Request Email Ctrl+Click Sub Status; For Renewal-Request SMS Ctrl+Click Mobile No.</p> 
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT s.sb_subscription_id, s.dos, s.doc, s.sub_status, p.photo, p.full_name, p.address, p.at_post, p.mobile_no, s.subscription_type FROM ak_p_registration p, ak_sb_subscription_form s WHERE p.person_id= s.person_id and s.magazine_name='Shivambu Samachar'";
