...
<!-- Document Header Start =================================== -->
    ...
    <h4 align="center"><b> Magazine Dispatch Alert Email </b> </h4>
                    ...
                    <div class="panel-body">    
                        <div class="form-group col-sm-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" cols="90" rows="1" id="email_subject" name="email_subject"> <?php echo $recordPr[8];?> : Dispatch Alert   </textarea>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">                        
...
आज हि इस महिने की <?php echo $recordPr[8];?> पत्रिका बुक-पोस्ट द्वारा आपके उपरोक्त पत्ते पर भेज दि गयी है. 
...
हर महिने के 10 तारीख को यह पत्रिका कोल्हापूर से पोस्ट होती है; आपको उसी महिने के बीस तारीख तक यह पत्रिका मिल जानी चहिये, अगर पत्रिका नहीं मिलती है तो आप पोस्ट ऑफीस में पुछ्ताछ करे.
...
$mail->Subject = $recordPr[8] . ' - Magazine Dispatch Alert';
...
<hr>
    ...
    <h2><b>$recordPr[8] - Dispatch Alert </b></h2><br><br>
    ...
    आज हि इस महिने की $recordPr[8] पत्रिका बुक-पोस्ट द्वारा आपके उपरोक्त पत्ते पर भेज दि गयी है.<br> 
    अगर यह पत्रिका आपको अगले 5-7 दिनों में नहीं मिळती तो कृपया आपने नज्दिकी पोस्ट ऑफिस में या पोस्टमैन से पुछ्ताछ करें.
...
$mail->AltBody = "This is a $recordPr[8] Magazine Dispatch Alert";
...
if (!$mail->send()) {
    ...
    echo "Magazine Dispatch Alert Email Sent $recordPr[0] ! <br>";
    //Section 2: IMAP
