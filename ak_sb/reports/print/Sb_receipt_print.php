                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            //echo $qryOrg;
                            {
                             ...
                             $qryPr="SELECT Distinct p.full_name, p.dob, p.at_post, p.mobile_no, p.address, r.sb_subscription_id, r.sb_payment_id, r.sb_payment_date, s.subscription_amount, r.amount_paid, r.balance_amount, r.payment_mode, r.payment_details, s.magazine_name, s.subscription_type FROM ak_p_registration p, ak_sb_subscription_form s, ak_sb_payment r WHERE p.person_id= s.person_id";
...
<!-- Document Header End ================================================== -->
    ...
    <p align="right"><span>Receipt No.:</span> <span> <?php echo $year;?>/0<?php echo $recordPr[6];?> </span>, <span>SB ID:</span> <span> <?php echo $recordPr[5];?></span>, <span style="font-family:IDAutomationHC39S; font-size:7px;"> <?php echo $recordPr[0];?> </span></p>
        <!--//-$month-$recordPr[5]-->
<!-- Payment Panel Starts================================== -->
                <div class="table-responsive">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="cs_table">
                        ...
                        <tr>
                            <th>Magazine:</th> <td><?php echo $recordPr[13]?></td>
                ...
                <div class="table-responsive">
                    <table style="font-size:15px" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <tr>                                 
                                <th width="50%"> <li>Subscription Amount:</li></th> 
