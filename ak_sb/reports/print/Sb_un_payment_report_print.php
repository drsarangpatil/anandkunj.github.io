<html lang="en">
    <head>
        <title> Print UriNews Payment Register</title>
        <meta charset="utf-8">
...
<!-- Document Header End ================================================== --> 
                <h4 align="center"><b> UriNews Payment Register</b></h4>
...
<!-- Php code for OP Case Sheet Table Starts =============================== -->
                            <?php 
                                ...
                                {
                                    {
                                        $query="SELECT Distinct p.full_name, r.sb_payment_id, r.sb_payment_date, s.subscription_type, p.photo,  p.at_post, p.mobile_no, s.subscription_amount, r.amount_paid, r.payment_mode, r.payment_details, s.magazine_name FROM ak_p_registration p, ak_sb_subscription_form s, ak_sb_payment r WHERE p.person_id= s.person_id and s.magazine_name='UriNews'";
