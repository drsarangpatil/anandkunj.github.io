<html lang="en">
    <head>
        <title> Print UrinNews Subscribers Register</title>
        <meta charset="utf-8">
                    ...
                    id="cs_table" >
                        <tr align="center">
                            <td width="15%" align="center">
                                ...
                                <img id="logo" name="logo" class="img-rounded"  width="150" height="100" src="../../../ak_com/database/logos/<?php echo $recordOrg[0];?>"   alt="logo not found>">
                                </a>
                            </td>
...
<!-- Document Header End ================================================== --> 
                <h4 align="center"><b> UrinNews - Subscribers Register</b></h4>
