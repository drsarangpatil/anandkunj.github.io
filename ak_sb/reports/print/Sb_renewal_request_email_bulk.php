...
$mail->Subject = $record[11] . ' - Subscription Renwal Request';
...
<hr>
    ...
    आपकी $record[11] की $record[12] सदस्यता $record[2] तारीख को समाप्त होती है, कृपया अगला शुल्क आप मिनिऑर्डर, डी. डी. से 'संदेश प्रकाशन' के नाम पर, अथवा Paytm व्दारा 9309979990 इस मोबाईल नंबर पर भेजकर, यह अमृतप्रवाह अखंड रखने में, कृपया हमे सहकार्य करे.<br>
    धन्यवाद!<br>
...
$mail->AltBody = "This is a $record[11] Subscription Renwal Request";
...
if (!$mail->send()) {
    ...
    echo "Subscription Renwal Request Email Sent to $record[5] ! <br>";
    //Section 2: IMAP
