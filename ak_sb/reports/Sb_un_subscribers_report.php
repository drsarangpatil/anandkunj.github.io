...
<title>UrinNews Subscribers Register</title>
...
// JS script for display button========>       
        ...
        {
            url ="";
            url += "Sb_un_subscribers_report.php?at_post=" + document.getElementById("at_post").value;
...
// JQ script for AJAX Call Ends =========> 
       ...
       <form action="" method="POST" class="form-inline">
             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> UrinNews Subscribers Register</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    UrinNews Subscribers Register
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> UrinNews Subscribers Register</b></h5><p style= "color:slateBlue"> For Dispatch-Alert Email Ctrl+Click Full Name; For Renewal-Request Email Ctrl+Click Sub Status; For Renewal-Request SMS Ctrl+Click Mobile No.</p>
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT s.sb_subscription_id, s.dos, s.doc, s.sub_status, p.photo, p.full_name, p.address, p.at_post, p.mobile_no, s.subscription_type FROM ak_p_registration p, ak_sb_subscription_form s WHERE p.person_id=s.person_id and s.magazine_name='UriNews'";
