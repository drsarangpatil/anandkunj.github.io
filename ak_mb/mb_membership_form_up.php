...
<title>Edit - Membership Form</title>

</head>
<body>
   
    <script src="js/myjs/get_association_membership.js"></script>
    <script src="js/myjs/get_mb_membership_form_up.js"></script>
<!-- JS Script for MB Duration Calculation====================== -->
    <script>
     function calculateSBDur(){
        ...
        <form action="database/Mb_membership_form_up.php" method="post">
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Edit - Membership Form </b></h4>
...
<!-- Membership Information  Pannel end ================================================== -->
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="mb_membership_form.php">New Membership Form</a>
                         </div>
                    </div>
				</div>
