	...
	if ($con)
	{
       ...
       if($process === "getOther_details")
        ...
        if($process === "getSelected_membership_data")
		{
			...
			$query = ("SELECT association_name, membership_type, membership_amount, mem_status, dos, doc, membership_duration, commune FROM ak_mb_membership_form WHERE mb_membership_id= '" . $mb_membership_id . "' and pay_status='Pending'");
