...
<!-- Document Header Start =================================== -->
    ...
    <h4 align="center"><b> Membership Renewal Request SMS </b> </h4>
    <p align="center"><span>Member Name:</span> <span> <?php echo $recordPr[0];?></span>, <span>Mobile No.:</span> <span> <?php echo $recordPr[1];?></span>, <span>Receipt No.:</span> <span> <?php echo $year;?>/0<?php echo $recordPr[2];?>, </span> <span>MB ID:</span> <span> <?php echo $recordPr[2];?></span></p>
<!-- Form Information ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">

                    <div class="panel-heading">
                        Membership Renewal Request SMS
                    </div>
                    <div class="panel-body">
                        <div class="form-group col-sm-12">
                            <label>SMS to be Sent:</label>
                            <div class="form-group">
                                <textarea class="form-control" cols="90" rows="3" id="mb_sms_template" name="mb_sms_template"> Dear <?php echo $recordPr[0];?>ji, your <?php echo $recordPr[4];?> membership for "<?php echo $recordPr[3];?>" is ending on <?php echo $recordPr[6];?>. Please RENEW. manager.anandkunj@gmail.com, 9404135010. </textarea>
                            </div>
                        </div>
				    </div>
                </div>
...
<?php
   ...
   // echo $recordPr[1];
    $message = "  Dear $recordPr[0] ji, your $recordPr[4] membership for $recordPr[3] is ending on $recordPr[6]. Please RENEW. yogesh.anandkunj@gmail.com, 9404135010";
