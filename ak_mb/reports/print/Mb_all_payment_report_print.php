<html lang="en">
    <head>
        <title> Print All Associations Payment Report</title>
        <meta charset="utf-8">
...
<!-- Document Header End ================================================== --> 
                <h4 align="center"><b> All Associations Payment Register</b></h4>
...
<!-- Php code for OP Case Sheet Table Starts =============================== -->
                            <?php 
                                ...
                                {
                                    {
                                        $query="SELECT Distinct p.full_name, r.mb_payment_id, r.mb_payment_date, s.membership_type, p.photo,  p.at_post, p.mobile_no, s.membership_amount, r.amount_paid, r.payment_mode, r.payment_details, s.association_name FROM ak_p_registration p,  ak_mb_membership_form s, ak_mb_payment r WHERE p.person_id= s.person_id";
