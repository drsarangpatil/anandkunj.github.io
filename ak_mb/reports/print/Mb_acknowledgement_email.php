...
<!-- Document Header Start =================================== -->
    ...
    <h4 align="center"><b> Membership Acknowledgement Email </b> </h4>
    <p align="center"><span>Members Name:</span> <span> <?php echo $recordPr[0];?></span>, <span>Email Id:</span> <span> <?php echo $recordPr[6];?></span>, <span>Receipt No.:</span> <span> <?php echo $year;?>/0<?php echo $recordPr[7];?>, </span><span>MB ID:</span> <span> <?php echo $recordPr[7];?></span></p>
<!-- Form Information ================================================== -->
...
आप "<?php echo $recordPr[8];?>" इस एसोसिएशन के सदस्य हुए है, आपका अभिनंदन ! 
आपने सदस्यता शुल्क भेजकर यह सदस्यता जारी रखने के लिये सहायता की उसके लिये हम आपके आभारी है.
...
$mail->Subject = $recordPr[8] . ' - Membership Acknowledgement';
...
<hr>
    ...
    <h2>$recordPr[8] - सदस्यता प्रमाणपत्र</h2><br><br>
    नाम : $recordPr[0] <br>
    ...
    $recordPr[2]<br><br>
    सप्रेम नमस्कार,<br>
    आप $recordPr[8] इस एसोसिएशन के सदस्य हुए है, आपका अभिनंदन !<br>
    आपने सदस्यता शुल्क भेजकर यह सदस्यता जारी रखने के लिये सहायता की उसके लिये हम आपके आभारी है.<br>
...
$mail->AltBody = "This is a $recordPr[8] Membership Acknowledgement";
...
if (!$mail->send()) {
    ...
    echo "Membership Acknowledgement Email Sent $recordPr[0] ! <br>" ;
    //Section 2: IMAP
