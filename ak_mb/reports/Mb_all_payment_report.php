...
<title>All Associations Payment Report</title>
...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "Mb_all_payment_report.php?association_name=" + document.getElementById("association_name").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            ...
            url=document.URL;
            url=url.replace("Mb_all_payment_report.php", "print/Mb_all_payment_report_print.php");
            //alert (url)
            window.open(url);
...
// JQ script for AJAX Call Ends =========> 
        ...
        <form action="" method="POST" class="form-inline">
             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> All Associations Payment Report</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    All Associations Payment Register
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> All Associations Payment Report</b></h5> <p style= "color:slateBlue"> For Receipt-Print Ctrl+Click on Full Name; For Acknowledgement Email Ctrl+Click on Email Id; For Acknowledgement SMS Ctrl+Click on Mobile No.</p> 
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT Distinct p.full_name, r.mb_payment_id, r.mb_payment_date, s.membership_type, p.photo,  p.email, p.mobile_no, s.membership_amount, r.amount_paid, r.payment_mode, r.payment_details, s.association_name FROM ak_p_registration p,  ak_mb_membership_form s, ak_mb_payment r WHERE p.person_id= s.person_id";
                                       ...
                                       //echo $query;
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                         echo '<tr class="odd gradeX" style="font-size:13px" >';
                                            ...
                                            echo '<td align="left"><a href= "print/Mb_acknowledgement_email.php?pyid=' .$record[1] . '">' . $record[5] . '</a></td>';
