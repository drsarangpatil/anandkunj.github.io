...
<title>DAYA Payment Report</title>
...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "Mb_daya_payment_report.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            ...
            url=document.URL;
            url=url.replace("Mb_daya_payment_report.php", "print/Mb_daya_payment_report_print.php");
            //alert (url)
            window.open(url);
...
// JQ script for AJAX Call Ends =========> 
        ...
        <form action="" method="POST" class="form-inline" >
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> DAYA Payment Report</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    DAYA Payment Register
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> DAYA Payment Report</b></h5><p style= "color:slateBlue"> For Receipt-Print Ctrl+Click on Full Name; For Acknowledgement Email Ctrl+Click on Email Id; For Acknowledgement SMS Ctrl+Click on Mobile No.</p> 
