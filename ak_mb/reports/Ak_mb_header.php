    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../index.php"> ANANDKUNJ - Membership</a>
        </div>
          <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="../mb_membership_form.php">Membership Form</a>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Operations <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../mb_payment.php">Membership Payment</a></li>
                        <li><a href="../mb_membership_deactivation.php">Membership Deactivation</a></li>
                        <li><a href="../../ak_mb/reports/Mb_all_members_report.php">Membership Reminder</a></li>
                    </ul>
                </li> 
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Update <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../mb_membership_form_up.php">Membership Form</a></li>
                        <li><a href="../mb_payment.php">Membership Payment</a></li>
                    </ul>
                </li>  
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="../reports/Mb_all_members_report.php">Membership Register</a></li>
                        <li><a href="../reports/Mb_daya_members_report.php">DAYA Members Register</a></li>
                        <li><a href="../reports/Mb_iaff_members_report.php">IAFF Members Register</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="../reports/Mb_all_payment_report.php">Payment Register</a></li>
                        <li><a href="../reports/Mb_daya_payment_report.php"> DAYA Payment Register</a></li>
                        <li><a href="../reports/Mb_iaff_payment_report.php">IAFF Payment Register</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <span class="glyphicon glyphicon-cog"></span> <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../mb_association_name.php">Association Master</a></li>
                        <li><a href="../mb_membership_type.php">Membership Type Master</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="../mb_association_name_up.php">Edit Association Master</a></li>
                        <li><a href="../mb_membership_type.php"> Edit Membership Type Master</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
