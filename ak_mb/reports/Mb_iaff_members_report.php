...
<title>IAFF Members Register</title>
...
// JS script for display button========>       
        ...
        {
            url ="";
            url += "Mb_iaff_members_report.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Mb_iaff_members_report.php", "print/Mb_iaff_members_report_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
        ...
        function aprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Mb_iaff_members_report.php", "print/Mb_address_labels_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
        ...
        function bprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Mb_iaff_members_report.php", "print/Mb_dispatch_alert_email_bulk.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
        ...
        function cprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Mb_iaff_members_report.php", "print/Mb_renewal_request_email_bulk.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JQ script for AJAX Call Ends =========> 
        ...
        <form action="" method="POST" class="form-inline">
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> IAFF Members Register</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    IAFF Members Register
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> Shivambu Samachar Subscribers Register</b></h5><p style= "color:slateBlue"> For Dispatch-Alert Email Ctrl+Click Full Name; For Renewal-Request Email Ctrl+Click Mem Status; For Renewal-Request SMS Ctrl+Click Mobile No.</p> 
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT s.mb_membership_id, s.dos, s.doc, s.mem_status, p.photo, p.full_name, p.address, p.at_post, p.mobile_no, s.membership_type FROM ak_p_registration p, ak_mb_membership_form s WHERE p.person_id= s.person_id and s.association_name='International Amroli Followers Forum'";
