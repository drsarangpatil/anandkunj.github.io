...
<title>All Association Membership Register</title>
...
// JS script for display button========>       
        ...
        {
            url ="";
            url += "Mb_all_members_report.php?at_post=" + document.getElementById("at_post").value;
            ...
            url += "&association_name=" + document.getElementById("association_name").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Mb_all_members_report.php", "print/Mb_all_members_report_print.php");
            //alert (url)
            window.open(url);
        ...
        function aprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Mb_all_members_report.php", "print/Mb_address_labels_print.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
        ...
        function bprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Mb_all_members_report.php", "print/Mb_dispatch_alert_email_bulk.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
        ...
        function cprintRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Mb_all_members_report.php", "print/Mb_renewal_request_email_bulk.php");
            //alert (url)
            window.open(url);
            //alert("sadsad");
        }
...
// JQ script for AJAX Call Ends =========> 
        ...
        <form action="" method="POST" class="form-inline">
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> All Association Membership Register</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    All Members Register
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> All Association Membership Register</b></h5><p style= "color:slateBlue"> For Dispatch-Alert Email Ctrl+Click Full Name; For Renewal-Request Email Ctrl+Click Mem Status; For Renewal-Request SMS Ctrl+Click Mobile No.; For Membership-Certificate Print Ctrl+Click Association</p> 
                                       ...
                                       //$i =1;
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="left"><a href= "print/Mb_membership_certificate_print.php?sbid=' .$record[0] . '">' . $record[9] . '</a></td>';
