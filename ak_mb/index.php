...
<!-- Php code for Donationt Table Starts =============================== -->
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    $Pagequery="SELECT s.mb_membership_id, s.dos, s.doc, s.mem_status, p.photo, p.full_name, p.address, p.at_post, p.mobile_no,  s.association_name, s.membership_type FROM ak_p_registration p, ak_mb_membership_form s WHERE p.person_id= s.person_id ";
                                    ...
                                    $Readquery="SELECT s.mb_membership_id, s.dos, s.doc, s.mem_status, p.photo, p.full_name, p.address, p.at_post, p.mobile_no,  s.association_name, s.membership_type FROM ak_p_registration p, ak_mb_membership_form s WHERE p.person_id= s.person_id";
