...
<body>
        ...
        <form action="database/Mb_membership_type_up.php" method="post">
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b>Update-Membership Type </b></h4>
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" 
                                       id="mb_membership_type_id" name="mb_membership_type_id">
                                </div>
                            </div>
...
<!-- Form Information Pannel Ends================================= -->
              <div class="panel-body">
                ...
                <div class="form-group col-sm-2">
                    <div class="form-group" >
                        <a class="btn btn-info pull-right" href="mb_membership_type.php">New Membership Type</a>
                     </div>
                </div>                 
            </div>  
            </div>
