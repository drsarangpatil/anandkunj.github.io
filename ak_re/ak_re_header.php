    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> ANANDKUNJ - Research</a>
        </div>
          <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Followup <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Followup Assessment</a></li>
                        <li><a href="#">Add Followup Assessment</a></li>
                    </ul>
                </li> 
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#">Post Assessment</a></li>
                        <li><a href="#">Followup Assessment</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#">Pre-Post Report</a></li>
