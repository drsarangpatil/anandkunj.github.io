<html lang="en">
    <head>
        <title>All Magazines SMS Communication System</title>
        <meta charset="utf-8">
...
// JS script for display button========>       
        ...
        {
            url ="";
            url += "Sb_all_sms_communication.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Sb_all_sms_communication.php", "print/Sb_all_sms_communication_sms.php");
            //alert (url)
            window.open(url);
...
<!-- Side NavBar End================================================== -->
        <form action="" method="POST" class="form-inline" >
                <div class="container col-sm-10">
                   <h4><b> All Magazines SMS Communication System</b></h4>
...
<!-- Form Information ================================================== -->
                    ...
                    <div class="panel-body">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" cols="100" rows="3" id="sb_sms_template" name="sb_sms_template" placeholder="Formt of SMS to be Sent"></textarea>
                            </div>
                        </div>
				    </div>
                </div>
                    ...
                    <div class="media">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="form-group" >
                                ...
                                <button type="button"class="btn btn-primary pull-center" onclick="printRepo()"> <span class="glyphicon glyphicon-envelope"> </span> SMS</button>
                            </div>
                        </div>
                    </div>
                </div>
