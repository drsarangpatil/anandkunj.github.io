...
<head>
    ...
    <!--favicon-->
    <link rel="shortcut icon" type="image/png" href="../ak_com/assets/images/A_Logo_green_32x32.png">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> ANANDKUNJ - Commune</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#">OP Case Sheet</a></li>
                        <li><a href="#">Medicine Prescription</a></li>
                        <li><a href="#">Lifestyle Prescription</a></li>
                        <li><a href="#">Treatment Prescription</a></li>
                        <li><a href="#">Diet Prescription</a></li>
                    </ul>
                </li>
                <li class="dropdown">
