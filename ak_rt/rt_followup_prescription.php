...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_followup_prescription.js"></script>

 <title>RT Followup Prescription</title>
...
<script>  
         function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_followup_prescription.php", "reports/Rt_followup_medicine_chart.php");
            //alert (url)
            window.open(url);
         ...
         function printRepo_b()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_followup_prescription.php", "reports/Rt_followup_ls_inst_chart.php");
            //alert (url)
            window.open(url);
...
<!-- JS Script for BMI Calculation====================== -->
    ...
    <form action="database/Rt_followup_prescription.php" method="post">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>RT Followup Prescription</b></h4>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group col-sm-2">
                        <label>BMI:</label>
                            <div class="form-group">
                            <input type="number" class="form-control"
                               id="bmi" name="bmi" size="10" readonly required>
                            </div>
                    </div>
                    <div class="form-group col-sm-2">
                        <label>Blood Pressure:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="bp" name="bp" placeholder="120/70" value="0" required>
                            </div>
                     </div>
...
<!-- RT Life Style Prescription Pannel ends================================================== -->
 ...
 <!-- Nav Tab Bar Pannel end ================================================== -->	
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_followup_prescription_up.php">Edit Fw Prescription</a>
                         </div>
                    </div>
			     </div>
