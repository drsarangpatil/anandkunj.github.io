...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_valuables_deposit_returned.js"></script>

    <title>Valuables_Deposit Returned</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_valuables_deposit_returned.php", "reports/Rt_deposit_returned_report.php");
            //alert (url)
            window.open(url);
        ...
        <form action="database/Rt_valuables_deposit_returned.php" method="post"  enctype="multipart/form-data">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Valuables-Deposit Returned </b></h4>
