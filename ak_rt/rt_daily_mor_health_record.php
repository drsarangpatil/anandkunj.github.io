...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_daily_mor_health_record.js"></script>

<title>Daily Morning Health Record</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_mor_health_record.php", "reports/Rt_treat_chart.php");
            //alert (url)
            window.open(url);
         ...
         function printRepo_b()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_mor_health_record.php", "reports/Rt_diet_chart.php");
            //alert (url)
            window.open(url);
        ...
        function printRepo_c()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_mor_health_record.php", "reports/Rt_daily_health_record.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_daily_mor_health_record.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Daily Morning Health Record</b></h4>
...
<!--Tab Diet Prescription ends-->
                ...
                <div class="form-group col-sm-2">
                   ...
                   <!-- <div class="form-group col-sm-2">
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_daily_mor_health_record_up.php">Update MR DH Record</a>
                         </div>
                    </div>
