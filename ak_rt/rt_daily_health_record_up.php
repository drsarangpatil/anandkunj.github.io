...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_daily_health_record_up.js"></script>

    <title>Update Daily Health Record</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_health_record_up.php", "reports/Rt_treat_chart.php");
            //alert (url)
            window.open(url);
         ...
         function printRepo_b()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_health_record_up.php", "reports/Rt_diet_chart.php");
            //alert (url)
            window.open(url);
        ...
        function printRepo_c()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_health_record_up.php", "reports/Rt_daily_health_record.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_daily_health_record_up.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Update Daily Health Record</b></h4>
...
<!-- Fetched All Daily Health Assessment Records Pannel starts ================================== -->
            <div class="panel-group">
                <div class="panel panel-primary">
                    ...
                    <div class="form-group col-sm-3">
                            <label>Daily HR ID:</label>
                            <div class="form-group" >
                                <input type="number" class="form-control"
                                   id="rt_daily_health_record_id" name="rt_daily_health_record_id">
                            </div>
                        </div>
                    ...
                    <div class="panel-body">
                      ...
                      <!--<div class="form-group col-sm-2">
                        ...
                        <label> Treatment Instructions</label>
                            <div class="form-group">
                            <input type="text" class="form-control" 
                                   id="treat_instructions" name="treat_instructions" value="0">
                            </div>
                        </div>
                        <div class="form-group col-sm-2">
                            <label></label>
                         ...
                         <div class="form-group col-sm-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="2" id="treatment_prescriptions" name="treatment_prescriptions" placeholder="Treatment Prescriptions"></textarea>
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
...
<!--Tab Diet Prescription ends-->
                ...
                <div class="form-group col-sm-2">
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_daily_health_record.php">Add DH Record</a>
                         </div>
                    </div>
			</div>
