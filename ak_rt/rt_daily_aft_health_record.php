...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_daily_aft_health_record.js"></script>

<title>Daily Afternoon Health Record</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_aft_health_record.php", "reports/Rt_treat_chart.php");
            //alert (url)
            window.open(url);
         ...
         function printRepo_b()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_aft_health_record.php", "reports/Rt_diet_chart.php");
            //alert (url)
            window.open(url);
        ...
        function printRepo_c()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_aft_health_record.php", "reports/Rt_daily_health_record.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_daily_aft_health_record.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Daily Afternoon Health Record</b></h4>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover"      id="dataTables-example">
                            ...
                            <tbody id="all_rt_daily_health_assessment_records">	
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="form-group col-sm-2">
                        <label>Weight:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="weight" name="weight" placeholder="50.8" required>
                            </div>
                     </div>
                    <div class="form-group col-sm-2">
                        <label>Blood Pressure:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="bp" name="bp" placeholder="120/70" required>
                            </div>
                     </div>
                     <div class="form-group col-sm-2">
                        <label>Amroli Kriya:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="amroli" name="amroli" placeholder="200ml/4 times" required>
                            </div>
                     </div>
                     <div class="form-group col-sm-2">
                        <label>Water Intake:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="water" name="water" placeholder="1 lit" required>
                            </div>
                     </div>
                    <div class="form-group col-sm-2">
                        <label>Detox Drink:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="detox" name="detox" placeholder="2 tsp" required>
                            </div>
                     </div>
                     <div class="form-group col-sm-2">
                        <label>Bowel Motions:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="motions" name="motions" placeholder="2 times" required>
                            </div>
                     </div>
                    <!--<div class="form-group col-sm-3">
                        <label>Other:</label>
                    ...
                    <div class="form-group col-sm-6">
                        <label>Today's Complaints:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="complaints" name="complaints" placeholder="headache, lower back pain, knee pain" required>
                            </div>
                     </div>
                     <div class="form-group col-sm-4">
                        <label>On Examination:</label>
                            <div class="form-group" >
                            <input type="text" class="form-control"
                                    id="oe" name="oe" placeholder="PR/RR/RBS/Girth" required>
                            </div>
                     </div>
                    <div class="form-group col-sm-2">
                        <label>Diet Status:</label>
                        <div class="form-group">
                            <select class="form-control" id="diet_status" name="diet_status" required>
                                <option></option>
                                <option>Diet</option>
                                <option>Fast</option>
                            </select>
                    ...
                    <div class="form-group col-sm-12">
                        <label>Today's Medicines (Prescribed if Any) :</label>
                        <div class="form-group">
                        <input type="text" class="form-control" value="0"
                               id="daily_medicine" name="daily_medicine" required>
                        </div>
                    </div>
                </div> 
            </div>
...
<!--Treatment Prescription ends-->
                ...
                <div class="form-group col-sm-2">
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_daily_aft_health_record_up.php">Update AFT DH Record</a>
                         </div>
                    </div>
			     </div>
