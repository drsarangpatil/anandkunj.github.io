...
<script>
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_routine_treat_m_chart_todays.php", "reports/Rt_daily_treat_chart_Thwise.php");
            //alert (url)
            window.open(url);
...
?> 
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <form action="database/Rt_routine_treat_m_chart_todays.php" method="post" class="form-inline">
