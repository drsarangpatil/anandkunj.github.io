...
<script src="js/myjs/get_rt_daily_mor_health_record_up.js"></script>

<title>Update Morning Daily Health Record</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_mor_health_record_up.php", "reports/Rt_treat_chart.php");
            //alert (url)
            window.open(url);
         ...
         function printRepo_b()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_mor_health_record_up.php", "reports/Rt_diet_chart.php");
            //alert (url)
            window.open(url);
        ...
        function printRepo_c()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_mor_health_record_up.php", "reports/Rt_daily_health_record.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_daily_mor_health_record_up.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Update Morning Daily Health Record</b></h4>
...
<!-- Fetched All Daily Treatment Records Pannel starts ================================== -->
    <div class="panel-group">
        <div class="panel panel-info">
            <div class="panel-heading">
                All Routine Treatment Records of above Participant 
            </div>
            <div class="panel-body">
                ...
                <!--<div class="form-group col-sm-3">
                    ...
                    <div class="form-group" >
                    <input type="number" class="form-control"
                    id="rt_treatment_prescription_id" name="rt_treatment_prescription_id">
                    </div>
                </div>
...
<!-- Updation Call Pannel starts ================================== -->
            <div class="panel-group">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        Choose the DATE for Updation of Treatment and Diet Record
                    </div>
                    <div class="panel-body">
                    <div class="form-group col-sm-3">
                        <label>Date:</label>
...
<!-- Updation Call Pannel Ends================================= -->
<!-- Treatment Prescription Pannel ================================================== -->
           <div class="panel panel-primary">
                <div class="panel-heading">
                    Daily Morning Treatment Prescription
                </div>
                    <div class="panel-body">
                        <!--<div class="form-group col-sm-6">
                       ...
                       <div class="form-group col-sm-6">
                            ...
                            <div class="form-group">
                                <select class="form-control" 
                                    ...
                                    <option></option>
                                    <option>मालीश + स्टीम</option>
                                    <option>मालीश + भूगर्भ</option>
                                    <option>मालीश + मृतिका स्नान</option>
                                    <option>मालीश + प्लेन स्नान</option>
                                </select>
                            </div>
                        </div>
                        <!--<div class="form-group col-sm-4">
                       ...
                       <!-- <div class="form-group col-sm-3">
                        ...
                        <div class="form-group col-sm-10">
                            <label> Instructions</label>
                                <div class="form-group">
                                <input type="text" class="form-control" 
                                       id="instruc" name="instruc" value="0">
                                </div>
                        </div>
                        <div class="form-group col-sm-2">
                            <label></label>
                         ...
                         <div class="form-group col-sm-12">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" rows="2" id="diet_prescriptions" name="diet_prescriptions" placeholder="Diet Prescriptions"></textarea>
                                </div>
                        </div>
...
<!--Tab Diet Prescription ends-->
                ...
                <div class="form-group col-sm-2">
                    ...
                    <!--<div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_daily_medicine_prescription_up.php">Update Daily Medicines</a>
                        </div>
                    </div>-->
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_daily_mor_health_record.php">Add MR DH Record</a>
                         </div>
                    </div>
			</div>
