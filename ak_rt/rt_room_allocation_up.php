...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_room_allocation_up.js"></script>

<title>Update - Participant Room Allocation</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_room_allocation_up.php", "reports/Rt_room_allocation_chart.php");
            //alert (url)
            window.open(url);
        ...
        <form action="database/Rt_room_allocation_up.php" method="post"  enctype="multipart/form-data">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Update Participant Room Allocation </b></h4>
...
<!-- Fetched CaseSheet Records Pannel starts ================================================== -->
            <div class="panel-group">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Room Allocation Record of above Person 
                    </div>
                    <div class="panel-body">
                    <div class="table-responsive">
                        <table width="100%" class="table table-striped table-bordered table-hover"      id="dataTables-example">
                            ...
                            <tbody id="Rt_room_allocation_record">	
                            </tbody>
                        </table>
                    </div>
                        <div class="form-group col-sm-3">
                            ...
                            <div class="form-group" >
                                <input type="number" class="form-control"
                                   id="rt_room_allocation_id" name="rt_room_allocation_id">
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
                            <label> &nbsp;</label>
...
<!-- Fetched CaseSheet Records Pannel Ends ================================================== -->
...
<!-- Fetched All Daily Health Assessment Records Pannel Ends================================= -->
                    ...
                    <div class="form-group col-sm-3">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_room_allocation.php">Add Room Info</a>
                         </div>
                    </div>
				</div>
