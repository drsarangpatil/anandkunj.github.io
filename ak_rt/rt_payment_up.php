...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_payment_up.js"></script>

    <title>Update PAN Details</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_payment_up.php", "reports/Rt_payment_report.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_payment_up.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b> Update PAN Details</b></h4>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <div class="form-group">
                                    <input type="date" class="form-control" 
                                           id="rt_payment_date" name="rt_payment_date" readonly>
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                               ...
                               <div class="form-group col-sm-3">
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        placeholder="Amount Paid" readonly>
                                    </div>
                                </div>
                                <div class="form-group col-sm-3">
