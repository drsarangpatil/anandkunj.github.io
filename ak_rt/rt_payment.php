...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_payment.js"></script>

    <title>RT Payment</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_payment.php", "reports/Rt_payment_report.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_payment.php" method="post">
       <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>RT Payment</b></h4>
...
<!-- Fetched RT Estimation Records Pannel Ends================================= -->
