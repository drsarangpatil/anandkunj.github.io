...
<title>RT Followup Register</title>
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Rt_followup_register.php", "print/Rt_followup_register_print.php");
            //alert (url)
            window.open(url);
...
// JQ script for AJAX Call Ends =========>                 
        ...
        <form action="" method="POST" class="form-inline" >
             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> RT Followup Register</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">

                    <div class="panel-heading">
				    RT Followup Register
				    </div>
                        ...
                        <div class="form-group col-sm-4">
                         ...
                         <div class="form-group col-sm-3 pull-right">
                            ...
                            <div class="form-group" >
                                ...
                                <button type="button" class="btn btn-primary" onclick="printRepo()"> <span class="glyphicon glyphicon-print"></span>  Fw Register</button>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                               ...
                                               // echo '<td align="left">' . $MdNm . '</td>';
                                                echo '<td align="left">
                                                <a href= "print/Rt_followup_med_prescription_print.php?fuid=' .$record[6] . '">' . nl2br($MdNm) . '</a> </td>';
                                               ...
                                               $qryLs="SELECT life_style_instructions FROM  ak_rt_followup_lifestyle WHERE rt_followup_id ='" . $record[6] ."' and followup_date= '" . $record[4] ."' and schedule= '" . $record[5] ."' ";
                                                ...
                                                echo '<td align="left">
                                                <a href= "print/Rt_followup_ls_prescription_print.php?fuid=' .$record[6] . '">' . nl2br($Ls) . '</a> </td>';
