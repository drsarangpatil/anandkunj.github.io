...
// JS script for display button=========>
        function dispRepo()
        {
            ...
            url += "Rt_medicine_chart.php?gender=" + document.getElementById("gender").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Rt_medicine_chart.php", "print/Rt_medicine_chart_print.php");
            //alert (url)
            window.open(url);
                        ...
                        else
                        {
                            ...
                            while($record = mysqli_fetch_array($response))
                            {
                                 ...
                                 echo '<tr class="odd gradeX" style="font-size:13px" >';
                                    ...
                                    echo '<td align="left">
                                    <a href= "print/Rt_medicine_prescription_print.php?mdid=' .$record[5] . '">' . $record[0] . '</a> </td>';
...
<!-- Php code for RT Medicine Ends =============================== -->
                    ...
                    <td><a href="../rt_daily_medicine_prescription.php">Go to Menu</a></td>
                    </div>
                </div>
            </div>
        </div>
