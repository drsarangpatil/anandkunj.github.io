...
<title>RT Deposit Returned Report</title>
...
// JS script for display button========>       
        function dispRepo()
        {
            ...
            url += "Rt_deposit_returned_report.php?at_post=" + document.getElementById("at_post").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            ...
            url=document.URL;
            url=url.replace("Rt_deposit_returned_report.php", "print/Rt_deposit_returned_report_print.php");
            //alert (url)
            window.open(url);
...
// JQ script for AJAX Call Ends =========>
        ...
        <form action="" method="POST" class="form-inline" >
             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> RT Deposit Returned Register</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">
                    <div class="panel-heading">
				    RT Deposit Returned Register
				    </div>
...
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> RT Deposit Returned Report</b></h5>
                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT y.rt_v_d_returned_date, p.photo, p.full_name, p.at_post, p.mobile_no, c.rt_case_sheet_id, y.rt_case_sheet_id, y.deposit_amount, y.returned_amount, y.balance_amount, y.v_items, y.v_d_status, y.rt_v_d_returned_id FROM ak_p_registration p, ak_rt_case_sheet c, ak_rt_valuables_deposit_returned y WHERE p.person_id= c.person_id  and c.rt_case_sheet_id= y.rt_case_sheet_id";


                                        if( isset($_GET["from_date"]))
                                           if( $_GET["from_date"]!==""  &&  $_GET["to_date"]!=="" )
                                            {
                                                $query = $query .   " and  (y.rt_v_d_returned_date between '".  $_GET["from_date"] . "' and '".  $_GET["to_date"] . "')"; 
                                            }
                                       ...
                                       //echo $query;
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="left"><a href= "print/Rt_deposit_returned_voucher.php?drid=' .$record[12] . '">' . $record[2] . '</a></td>';
                                            ...
                                            echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                echo '<td style="font-weight: bold" align="right">Total Deposit Returned</td>';
                                                echo '<td align="center"></td>';
                                                echo '<td align="left"></td>';
                                                echo '<td align="left"></td>';
                                                echo '<td align="center"></td>';
                                                echo '<td align="center"></td>';
                                                echo '<td style="font-weight: bold"  align="right">' . number_format((float) $tobill_amt, 2, '.', '') . '</td>';
                                                echo '<td style="font-weight: bold"  align="right">' . number_format((float) $paid_amt, 2, '.', '') . '</td>';
                                                echo '<td style="font-weight: bold"  align="right">' . number_format((float) $bal_amt, 2, '.', '') . '</td>';
                                                //echo '<td align="left"></td>';
                                                echo '<td align="left"></td>';
                                                echo '<td align="left"></td>';
                                            echo "</tr>";
...
<!-- Php code for RT Case Sheet Table Ends =============================== -->
                    ...
                    <td><a href="../rt_valuables_deposit_returned.php">Go to Menu</a></td>
                    </div>
                </div>
            </div>
        </div>
