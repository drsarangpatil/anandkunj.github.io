				    ...
				    <div class="media">
				        <div class="media-body">
                            <div class="layout" style= "color:Black">
                                ...
                                <p align="center"> <span> <b><?php echo $recordPr[2];?></b></span><br>
                                <span> <?php echo $recordPr[15];?> </span></p>
                                <p align="center"> <span>DOA:</span> <span><?php echo $recordPr[3];?></span>, <span>DOC:</span> <span><?php echo $recordPr[14];?></span> <br>
                                <span>Room:</span> <span><?php echo $recordCs[0];?></span>, <span>Mobile:</span> <span><?php echo $recordPr[11];?></span> <br>
                                <span style="font-family:IDAutomationHC39S; font-size:7px;"> <?php echo $recordPr[2];?> </span></p>
                            </div>
                            <div class="layout" style= "color:Black">
								<img id="photo" name="photo" class="img-rounded"  width="40" height="50" src="../../../ak_com/database/photos/<?php echo $recordPr[1];?>"  alt="Image not uploded">
