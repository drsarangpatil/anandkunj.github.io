...
<!-- Document Header End ================================================== -->
    ...
    <p align="right"><span>Bill No.:</span> <span> <?php echo $year;?>/0<?php echo $recordPr[14];?> </span>, <span>CS ID:</span> <span> <?php echo $recordPr[4];?></span>, <span style="font-family:IDAutomationHC39S; font-size:7px;"> <?php echo $recordPr[0];?> </span></p>
