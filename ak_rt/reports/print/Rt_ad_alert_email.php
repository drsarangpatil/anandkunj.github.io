...
$mail->addAddress($recordPr[12], $recordPr[7]);

//Set the subject line
$mail->Subject = 'Anandkunj Retreat Admision-Booking Reminder- Alert';
...
आपके अनुरोध के अनुसार, हमने तारीख $recordPr[0] को $recordPr[1] सत्र में, $recordPr[2] बजे, आनंद्कुंज में स्वास्थ्य-शिविर के लिए आपका एडमिशन-बुकिंग तय कर लिया है । आपको उपरोक्त दिन, समय पर उपस्थित रहकर शिविर-सेवा का लाभ लेना है। <br><br> 
...
अधिक जानकारी के लिये या अगली अपोइन्टमेंट के लिए कृपया 0231-2321565 इस फोन नंबर पर सुबह 10.00 से शाम 6.00 तक संपर्क करे। <br><br>";
...
if (!$mail->send()) {
    ...
    echo "RT Admisssion Alert Email Sent to $recordPr[7] !" ;
    //Section 2: IMAP
