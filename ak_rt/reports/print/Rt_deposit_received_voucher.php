...
<html lang="en">
    <head>
        <title>RT Deposit Received Voucher</title>
        <meta charset="utf-8">
                ...
                <?php 
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            $qryPr="SELECT p.full_name, p.dob, p.at_post, p.mobile_no, c.rt_case_sheet_id, y.rt_v_d_received_date, y.deposit_amount, y.v_items, y.rt_v_d_received_id, c.retreat_name, c.doa, c.doc FROM ak_p_registration p, ak_rt_case_sheet c, ak_rt_valuables_deposit_received y WHERE p.person_id= c.person_id and c.rt_case_sheet_id= y.rt_case_sheet_id";
                            $qryPr=$qryPr . " and y.rt_v_d_received_id = ". $_GET["drid"];
...
<!-- Document Header End ================================================== -->
    <h4 align="center"><b> Deposit Received Voucher</b> </h4>
    <p align="right"><span>Voucher No.:</span> <span> <?php echo $year;?>/0<?php echo $recordPr[8];?> </span>, <span>CS ID:</span> <span> <?php echo $recordPr[4];?></span>, <span style="font-family:IDAutomationHC39S; font-size:7px;"> <?php echo $recordPr[0];?> </span></p>
...
<!-- Payment Panel Starts================================== -->
                <div class="table-responsive" style="font-size:15px">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="cs_table">
                        ...
                        <tr>
                            <th>Retreat:</th> <td><?php echo $recordPr[9];?>
                            <th>DOA:</th> <td><?php echo $recordPr[10];?></td>
                            <th>DOC:</th> <td><?php echo $recordPr[11];?></td>
                        </tr>
                    </table>
                </div>
                <div class="table-responsive">
                    <table style="font-size:15px" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <tr>                                 
                                <th> <li>Deposit Amt:</li></th> 
                                <td align="right"><?php echo number_format("$recordPr[6]",2)."<br>";?></td>
                            </tr>
                            <tr>                                 
                                <th> <li>Valuables:</li></th> 
                                <td align="right"><?php echo $recordPr[7];?></td>
                            </tr>
                            <!--<tr align="right" style="font-size:15px"> 
                             <th align="center"> 
                                 <li>Total Deposit:</li> </th>
                                <td> <b> <?php echo number_format("$recordPr[6]",2)."<br>";?> </b></td>
                            </tr>-->
                        </table>
                    </div>
     <p style="font-size:15px" align="left"><span>Deposit Received: <?php echo "&#8377  ".$result;?> only.</span></p>
                    
    <p style="font-size:15px" align="right"><span>Authorized Signature</span></p>
    <p style="font-size:15px" align="left"><span>Depositors Signature</span></p>
 <!-- Payment Panel Ends================================== -->
                    <br><br>
    <h4 align="center"><b> Deposit Received Voucher</b> </h4>
    <p align="right"><span>Voucher No.:</span> <span> <?php echo $year;?>/0<?php echo $recordPr[8];?> </span>, <span>CS ID:</span> <span> <?php echo $recordPr[4];?></span>, <span style="font-family:IDAutomationHC39S; font-size:7px;"> <?php echo $recordPr[0];?> </span></p>
