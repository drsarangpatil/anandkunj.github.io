...
<html lang="en">
    <head>
        <title> Print - 2nd Attendant I Card</title>
        <meta charset="utf-8">
                    ...
                    try
                    {
                        ...
                        else
                        {
                           ...
                           // echo $qryCs;
                            ...
                            $qryAtn="SELECT attendant_name2, relation2, mobile_no2  FROM ak_rt_attendant_info WHERE rt_attendant_info_id ='" . $recordPr[16] ."' ";
                                            
                            $resAtn = mysqli_query($con, $qryAtn);
                            $atn2="";
                            while($recordAtn = mysqli_fetch_array($resAtn))
                            {
                                $atn2 =  $atn2.$recordAtn[0] . ' (' . $recordAtn[1] . ') ' . $recordAtn[2] . "</br>";
                            }
				    ...
				    <div class="media">
				        <div class="media-body">
                            <div class="layout" style= "color:Black">
                                ...
                                <p align="center"> <span> <b><?php echo $recordPr[2];?></b></span><br> <span> <?php echo $atn2;?> </span></p>
