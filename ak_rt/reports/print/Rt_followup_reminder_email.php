...
<h2>Retreat Followup Reminder</h2><br><br>
...
आपने $recordPr[10] दिन आनंद्कुंज में रहकर स्वास्थ्य साधना पूरी की है, इसलिए आपका अभिनन्दन. आप तेजीसे आपने स्वास्थ्य लक्ष्य की ओर बढ़ रहें हैं! <br><br>
...
किसी भी प्रश्न के लिए, 9404135011 इस नंबर पर कार्यालयीन समय के दौरान संपर्क करने में संकोच न करें (सुबह 10.00  से शाम 6.00 बजे तक)। आपकी अगली भेंट या सम्पर्क फोलोअप $followup_date तारीख पर निर्धारित की गयी है। <br><br> 
...
अधिक जानकारी के लिये या फोलोअप अपोइन्टमेंट के लिए कृपया 0231-2321565 इस फोन नंबर पर सुबह 10.00 से शाम 6.00 तक संपर्क करे. <br>";
                    
$mail->AltBody = "This is a Retreat Followup Reminder Email";
...
if (!$mail->send()) {
    ...
    echo "Retreat Followup Reminder Email Sent to $recordPr[0] ! " ;
    //Section 2: IMAP
