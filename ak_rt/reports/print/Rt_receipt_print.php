...
<!-- Document Header End ================================================== -->
    ...
    <p align="right"><span>Receipt No.:</span> <span> <?php echo $year;?>/0<?php echo $recordPr[5];?> </span>, <span>CS ID:</span> <span> <?php echo $recordPr[4];?></span>, <span style="font-family:IDAutomationHC39S; font-size:7px;"> <?php echo $recordPr[0];?> </span></p>
        <!--//-$month-$recordPr[5]-->
<!-- Payment Panel Starts================================== -->
    ...
    <p style="font-size:15px" align="left"><span> Payment Details: <?php echo $recordPr[11];?>.</span><span> PAN Name: <?php echo $recordPr[16];?>, PAN No.: <?php echo $recordPr[17];?></span></p>
