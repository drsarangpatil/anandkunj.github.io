<html lang="en">
    <head>
        <title> Print-RT Booking Register</title>
        <meta charset="utf-8">
...
<!-- Document Header End ================================================== --> 
                <h5 align="center"><b> RT Booking Register</b></h5><p align="center"><b>(Room Expected: <?php echo $_GET["rm_expected"];?>; Ad Status: <?php echo $_GET["ad_status"];?>; At Post: <?php echo $_GET["at_post"];?>; AD Date: from <?php echo $_GET["from_date"];?>  to <?php echo $_GET["to_date"];?>)</b></p>
