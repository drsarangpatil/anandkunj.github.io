...
<html lang="en">
    <head>
        <title>Print - RT Followup Medicine Prescription</title>
        <meta charset="utf-8">
...
<!-- Prescription Panel Starts================================== -->
            <div class="table-responsive">
                <table width="100%" class="table table-striped table-bordered table-hover"                      id="cs_table">
                        ...
                        <tr>
                            <th>Complaints:</th> 
                            <td colspan="5"><?php echo $recordFw[0];?></td>
                        </tr>
                        <tr>
                            <th colspan="1">O/E:</th> 
                            <td colspan="2"><?php echo $recordFw[4];?></td>
                            <th colspan="1">BP:</th> 
                            <td colspan="2"><?php echo $recordFw[3];?> mmHg</td>
                        </tr>
                </table>
               <!-- <table width="100%" class="table table-striped table-bordered table-hover"                      id="cs_table">
                        <tr>
...
<!-- Php code for OP Medicine Starts =============================== -->
                         <?php 
                                ...
                                {
                                    {
                                        $query="SELECT medicine_names  FROM  ak_rt_followup_medicine WHERE rt_followup_id ='" . $recordPr[4] ."'";
