<html lang="en">
    <head>
        <title>Print RT Followup Medicine Chart</title>
        <meta charset="utf-8">
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                               ...
                                               echo '<td align="left">' . $MdNm . '</td>';
                                                //echo '<td align="left"><a href= "print/Rt_followup_med_prescription_print.php?fuid=' .$record[6] . '">' . nl2br($MdNm) . '</a> </td>';
                                               ...
                                               $qryLs="SELECT life_style_instructions FROM  ak_rt_followup_lifestyle WHERE rt_followup_id ='" . $record[6] ."' and followup_date= '" . $record[4] ."' and schedule= '" . $record[5] ."' ";
                                                ...
                                                //echo '<td align="left"><a href= "print/Rt_followup_ls_prescription_print.php?fuid=' .$record[6] . '">' . nl2br($Ls) . '</a> </td>';
