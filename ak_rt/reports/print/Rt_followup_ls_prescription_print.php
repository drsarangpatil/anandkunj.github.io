...
<html lang="en">
    <head>
        <title>Print - RT Followup LS Prescription</title>
        <meta charset="utf-8">
                ...
                <?php 
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            $qryPr="SELECT p.full_name, p.dob, p.gender, c.rt_case_sheet_id, f.rt_followup_id, f.followup_date, f.schedule, f.complaints, f.weight, f.bp, f.oe FROM ak_p_registration p, ak_rt_case_sheet c, ak_rt_followup f WHERE p.person_id= c.person_id and c.rt_case_sheet_id= f.rt_case_sheet_id";
                            $qryPr=$qryPr . " and f.rt_followup_id = ". $_GET["fuid"];
...
<!-- Php code for Followup Clinical Data Starts =============================== -->
                         <?php 
                                $retStr = "";
                                try
                                {
                                    {
                                        $queryfw="SELECT complaints, weight, bmi, bp, oe, investigations  FROM  ak_rt_followup WHERE rt_followup_id ='" . $recordPr[4] ."'";
                                        
                                        //echo $query;

                                       $resFw = mysqli_query($con, $queryfw);
                                        $recordFw = mysqli_fetch_array($resFw);
                            ...
                            ?>
<!-- Php code for Followup Clinical Data Ends =============================== -->
            ...
            <div class="table-responsive">
                <table width="100%" class="table table-striped table-bordered table-hover"                      id="cs_table">
                        <tr>
                            ...
                            <th>Weight:</th> <td><?php echo $recordFw[1];?> kg</td>
                        </tr>
                        <tr>
                       ...
                       <!-- <tr>
                            <th colspan="2">Present Complaints:</th> 
                            <td colspan="4"><?php echo $recordFw[0];?></td>
                        </tr>
                        <tr>
                            <th colspan="1">O/E:</th> 
                            <td colspan="3"><?php echo $recordFw[4];?></td>
                            <th colspan="1">BP:</th> 
                            <td colspan="1"><?php echo $recordFw[3];?> mmHg</td>
                        </tr>-->
                </table>
               <!-- <table width="100%" class="table table-striped table-bordered table-hover"                      id="cs_table">
                        <tr>
...
<!-- Php code for OP Medicine Starts =============================== -->
                         <?php 
                                ...
                                {
                                    {
                                        $query="SELECT life_style_instructions FROM  ak_rt_followup_lifestyle WHERE rt_followup_id ='" . $recordPr[4] ."'";
