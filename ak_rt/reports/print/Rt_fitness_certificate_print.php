...
<html lang="en">
    <head>
        <title>RT Fitness Certificate</title>
        <meta charset="utf-8">
...
<h4 align="center"><b> FITNESS CERTIFICATE</b> </h4>
                ...
                <div class="panel-group">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="cs_table">
                        <tr> 
                            ...
                            therefore was admitted at this Institution <br><br>
                            from <?php echo $recordPr[3];?> to <?php echo $recordPr[14];?> <br><br>
                            for Yogic and Naturopathic treatments. <br><br> 
                            Now he/she is medically fit to join his/her routine work.  <br><br><br>
