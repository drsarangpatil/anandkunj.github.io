...
<html lang="en">
    <head>
        <title>RT Participation Certificate</title>
        <meta charset="utf-8">
...
<h4 align="center"><b> PARTICIPATION CERTIFICATE</b> </h4>
<!-- CS Clinical Info Panel Starts================================== -->
                <div class="panel-group">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="cs_table">
                        <tr> 
                            <td align="center" style="font-size:22px"><br>  This certificate is given to <br><br>
                            <b style="font-size:22px"><?php echo $recordPr[2];?></b><br><br>
                            for successfully completing and participating in <br><br> the Retreat entitled <br><br>
                            "<?php echo $recordPr[15];?>" <br><br>
                            from <?php echo $recordPr[3];?> to <?php echo $recordPr[14];?> <br><br>
                            at this Institution. <br><br> <br>
                            <b style="font-size:18px"><span>ANANDKUNJ DIRECTOR &nbsp; &nbsp; &nbsp; SVM DIRECTOR</span> </b> 
