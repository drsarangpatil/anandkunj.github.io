...
<!-- Document Header End ================================================== -->
    <h4 align="center"><b> Retreat Case - Sheet</b> </h4>
    <p align="right">CS ID: <span> <?php echo $recordPr[0];?>, </span> <span style="font-family:IDAutomationHC39S; font-size:7px;"> <?php echo $recordPr[2];?> </span></p>
