...
<html lang="en">
    <head>
        <title>RT Discharge Sheet</title>
        <meta charset="utf-8">
                ...
                <?php 
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            $qryPr="SELECT c.rt_case_sheet_id, p.photo, p.full_name, c.doa, p.occupation, p.dob, p.gender, p.marital_status, p.male_child, p.female_child, p.email, p.mobile_no, p.at_post,  p.address, c.doc, c.retreat_name FROM ak_p_registration p, ak_rt_case_sheet c WHERE p.person_id= c.person_id and c.ad_status !='Admitted'";
...
<!-- Document Header End ================================================== -->
    <h4 align="center"><b> Retreat Completion  Report</b> </h4>
                ...
                <div class="panel-group">
                   ...
                   <!-- <table width="100%" class="table table-striped table-bordered table-hover"         id="cs_table">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" 
                        ...
                        id="cs_table">
                        <tr>
                            <td align="justify" style="font-size:13px"> <b><?php echo $recordPr[15];?></b> is an Integrated Life Style Modification Program. It includes the practice of various non-pharmacological, non-invasive modalities like Yogic Therapy, Pranayam and Meditation; Naturopathic Methods and Amroli Kriya and Kalpa;  Ayurvedic  Panchkarma and Herbal Therapies; Diet and Nutrition, Therapeutic Fasting; Massage therapy and Manipulative Treatment; Hydro therapy and Mud Therapy; Magnet therapy and Acupressure;  Positive Thinking and Autosuggestions. <br><br> On successful completion of above practice and training participant was discharged on <?php echo $recordPr[14];?>. <br><br> <b>Follow-up:</b> Participant is given, a schedule of follow-up home work to be followed at home for next three months. </td>
                        </tr>
                    </table>
