<html lang="en">
    <head>
        <title>Print - RT Deposit Returned Register </title>
        <meta charset="utf-8">
...
<!-- Document Header End ================================================== --> 
                <h5><b>RT Deposit Returned Register</b></h5>
                                ...
                                {
                                    {
                                       ...
                                       //echo $query;
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                            ...
                                            echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                echo '<td colspan="7" style="font-weight: bold" align="right">Total Deposit Returned</td>';
