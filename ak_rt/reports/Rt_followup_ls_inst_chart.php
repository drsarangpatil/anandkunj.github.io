...
<title>RT Followup Life Style Instructions Chart</title>
...
// JS script for display button=========>
        function dispRepo()
        {
            ...
            url += "Rt_followup_ls_inst_chart.php?gender=" + document.getElementById("gender").value;
...
// JS script for print button=========>         
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("Rt_followup_ls_inst_chart.php", "print/Rt_followup_ls_inst_chart_print.php");
            //alert (url)
            window.open(url);
...
// JQ script for AJAX Call Ends =========>                 
    ...
    <form action="" method="POST" class="form-inline" >
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                   <h4><b> RT Followup Life Style Instructions Chart</b></h4>
<!-- Filters for Sorting Columns ================================================== -->
                    <div class="panel-group">
                    <div class="panel panel-primary">

                    <div class="panel-heading">
				    RT Followup Life Style Instructions Chart
				    </div>
                        ...
                        <div class="form-group col-sm-4">
                         ...
                         <div class="form-group col-sm-3 pull-right">
                            ...
                            <div class="form-group" >
                                ...
                                <button type="button" class="btn btn-primary" onclick="printRepo()"> <span class="glyphicon glyphicon-print"></span>  LS Chart</button>
                            </div>
                        </div>
                    </div>
                </div>
<!-- Filters for Sorting Columns Ends ================================================== -->
                <h5><b> RT Followup Life Style Instructions Chart</b></h5>
                                    ...
                                    else
                                    {
                                        ...
                                        while($record = mysqli_fetch_array($response))
                                        {
                                             ...
                                             echo '<tr class="odd gradeX" style="font-size:13px" >';
                                                ...
                                                echo '<td align="left">
                                                <a href= "print/Rt_followup_ls_prescription_print.php?fuid=' .$record[6] . '">' . $record[0] . '</a> </td>';
