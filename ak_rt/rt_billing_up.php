...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_billing_up.js"></script>

<title>Update - RT Estimation</title>
...
<!-- JS script for Calculations====================== -->  
    ...
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_billing_up.php", "reports/Rt_billing_report.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_billing_up.php" method="post">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Update - RT Estimation</b></h4>
                            ...
                            <div class="well">
							  <div class="media">
                                ...
                                <div> 
									...
									<img id="photo" name="photo" class="img-rounded"  width="137" height="171" src="../ak_com/images/a25.jpg" alt="Image not uploded">
								    </a>
                                </div>
...
<!-- Fetched RT Estimation Records Pannel starts ================================== -->
                <div class="panel-group">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            All RT Estimation Records 
                        </div>
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-        hover" id="dataTables-example">
                                ...
                                <tbody id="old_estimation_records_list">	
                                </tbody>
                            </table>
                            <div class="form-group col-sm-2">
                                <label>RT E ID :</label>
                                <div class="form-group" >
                                    <input type="number" class="form-control"
                                       id="rt_estimation_id" name="rt_estimation_id">
                                </div>
                            </div>
                            <div class="form-group col-sm-2">
                                <label> &nbsp;</label>
...
<!-- Fetched RT Estimation Records Records Pannel Ends================================= -->
...
<!--Details of RT Charges Pannel ends-->
               <div class="form-group col-sm-8">
                ...
                <div class="form-group col-sm-2">
                    <div class="form-group" >
                        <a class="btn btn-info pull-right" href="rt_billing.php">Add Bill</a>
                     </div>
                </div>
			</div>
