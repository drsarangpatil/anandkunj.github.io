...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_case_sheet_up.js"></script>
...
<title>Update - Retreat Case Sheet</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_case_sheet_up.php", "reports/Rt_cs_register.php");
            //alert (url)
            window.open(url);
...
<!-- JS Script for RT DOC Calculation====================== -->
    ...
    function rtDuration(){
        ...
        <form action="database/Rt_case_sheet_up.php" method="post">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Update - Retreat Case Sheet</b></h4>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group col-sm-3">
                            ...
                            <div class="form-group" >
                                <input type="number" class="form-control"
                                   id="rt_case_sheet_id" name="rt_case_sheet_id">
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
                            <label> &nbsp;</label>
...
<!-- Final Diagnosis Pannel end ================================================== -->					
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_case_sheet.php">Add RT Case-Sheet</a>
                         </div>
                    </div>
				</div>
