...
<script src="js/myjs/get_rt_daily_medicine_prescription.js"></script>

<title>Daily RT Medicine Prescription</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_medicine_prescription.php", "reports/Rt_medicine_chart.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_daily_medicine_prescription.php" method="post">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Daily RT Medicine Prescription</b></h4>
            ...
            <div class="panel-group">
                <div class="panel panel-primary">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="form-group">
                            <input type="date" class="form-control" 
                               onchange= "calculateRTdays()" id="daily_date" name="daily_date" required>
                        </div>
                    </div>
                    <!--<div class="form-group col-sm-3">
...
<!--Tab Medicine Prescription starts-->
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Daily RT Medicine Prescription
                </div>
                    <div class="panel-body">
                         <div class="form-group col-sm-3">
...
<!--Tab Medicine Prescription ends-->				
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_daily_medicine_prescription_up.php">Edit RT Med Presc</a>
                         </div>
                    </div>
			     </div>
