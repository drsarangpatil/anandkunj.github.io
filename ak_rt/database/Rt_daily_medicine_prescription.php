<?php
    ...
    echo "<script> window.open('../reports/print/Rt_medicine_prescription_print.php?mdid=" . $rt_medicine_prescription_id ."' ,'_blank'); </script>";
	echo "<script> location.replace('../rt_daily_medicine_prescription.php'); </script>";
