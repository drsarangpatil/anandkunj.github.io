<?php
	...
	if ($con)
	{
        ...
        if($process === "getRt_daily_health_records")
		{
            ...
            $query = ("SELECT d.daily_date, a.weight, a.bp, a.oe, a.amroli, a.water, a.detox, a.motions, a.complaints, d.schedule, d.retreat_day FROM ak_rt_daily_health_record d, ak_rt_daily_assessment_record a WHERE d.rt_daily_health_record_id= a.rt_daily_health_record_id and d.rt_case_sheet_id = '" . $rt_case_sheet_id ."'");
