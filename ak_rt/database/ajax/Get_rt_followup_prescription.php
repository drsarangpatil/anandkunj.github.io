<?php
	...
	if ($con)
	{
		...
		{
			//echo "4";
			$query = ("SELECT Distinct p.full_name, p.at_post FROM ak_p_registration p, ak_rt_case_sheet c WHERE p.isparticipant='Participant'");
            try
            {
        ...
        if($process === "getClinical_details")
		{
            $rt_case_sheet_id=filter_input(INPUT_GET, 'rt_case_sheet_id');
			//echo "6";
            
            $query = "SELECT present_complaints, weight, height, clinical_examination, investigations FROM ak_rt_case_sheet WHERE rt_case_sheet_id = '" . $rt_case_sheet_id ."'";
       ...
       /*  if($process === "getClinical_details")
		{
            ...
            $query = ("SELECT present_complaints, clinical_examination, weight, height, investigations FROM ak_rt_case_sheet WHERE rt_case_sheet_id = '" . $rt_case_sheet_id ."'");
