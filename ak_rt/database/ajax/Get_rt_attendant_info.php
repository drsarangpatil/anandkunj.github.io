<?php
	...
	if ($con)
	{
         ...
         if($process === "getRt_attendant_info_details")
		{
            ...
            $query = ("SELECT rt_attendant_info_id, no_attendant, attendant_name1, mobile_no1, relation1, attendant_name2, mobile_no2, relation2 FROM  ak_rt_attendant_info WHERE rt_case_sheet_id = '" . $rt_case_sheet_id ."'");
