<?php
	...
	if ($con)
	{
        ...
        if($process === "getAll_rt_treatment_records")
		{
            ...
            $query = ("SELECT daily_date, treatment_name, therapy_dept, treatment_time, therapist_name, treat_instructions, schedule FROM ak_rt_daily_treatment_prescription WHERE rt_case_sheet_id = '" . $rt_case_sheet_id ."' and schedule='Morning'");
