<?php
	...
	if ($con)
	{
        ...
        if($process === "getAll_details")
		{
			...
			$query = ("SELECT person_id, dor, full_name,  gender, dob, pob, marital_status, male_child, female_child, occupation, occu_spl_fea, photo, address, at_post, pin_code, nation_name, state_name, district_name, tahsil_name, passport_no, passport_doc, residence_phone, mobile_no, emergency_no, whatsapp_no, email, reference, person_category, user_id FROM ak_p_registration WHERE full_name = '" . $full_name . "'");
