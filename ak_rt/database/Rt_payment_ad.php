<?php
	...
	if ($con)
	{
		...
		
		{
            ...
            $query1= "UPDATE ak_rt_payment SET payment_status='". $_POST["payment_status"]."' WHERE rt_estimation_id='" . $_POST["rt_estimation_id"] ."'";
	...
	echo "<script> location.replace('../rt_payment_ad.php'); </script>";
