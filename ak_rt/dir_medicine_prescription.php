...
<title>Direct Medicine Prescription</title>
...
<script>    
    function printRepo_a()
    {
        url ="";
        url=document.URL;
        url=url.replace("dir_medicine_prescription.php", "reports/Dir_medicine_prescription_report.php");
        //alert (url)
        window.open(url);
    ...
    <form action="database/Dir_medicine_prescription.php" method="post">
           <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Medicine Prescription</b></h4>
                        ...
                        <div class="form-group col-sm-3">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" 
                                   id="prescri_id" name="prescri_id"readonly>
                            </div>
                        </div>
...
<!--Tab Medicine Prescription ends-->	
                    ...
                    <div class="form-group col-sm-4">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="dir_medicine_prescription_up.php">Edit Medicine Prescription</a>
                         </div>
                    </div>
			     </div>
