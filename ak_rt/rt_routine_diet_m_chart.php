...
<script>
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_routine_diet_m_chart.php", "reports/Rt_diet_chart.php");
            //alert (url)
            window.open(url);
...
?> 
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <form action="database/Rt_routine_diet_m_chart.php" method="post" class="form-inline">
           <!--<h4 align="left"><b> Routine Male Treatment Chart : <span><?php echo date("d-m-Y");?></span></b></h4>-->
            <h4 align="left"><b>Male Diet Chart</b></h4>
