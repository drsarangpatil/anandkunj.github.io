...
<?php include 'ak_rt_header.php';?>
    ...
    <script src="js/myjs/get_rt_daily_aft_health_record_up.js"></script>

<title>Update Daily Afternoon Health Record</title>
...
<!-- JS script for print button====================== -->
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_aft_health_record_up.php", "reports/Rt_treat_chart.php");
            //alert (url)
            window.open(url);
         ...
         function printRepo_b()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_aft_health_record_up.php", "reports/Rt_diet_chart.php");
            //alert (url)
            window.open(url);
        ...
        function printRepo_c()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_daily_aft_health_record_up.php", "reports/Rt_daily_health_record.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_daily_aft_health_record_up.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>Update Daily Afternoon Health Record</b></h4>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover"      id="dataTables-example">
                            ...
                            <tbody id="all_rt_daily_aft_health_records">	
                            </tbody>
                        </table>
                    </div>
                </div>
...
<!-- Updation Call Pannel starts ================================== -->
            <div class="panel-group">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        Choose the DATE for Updation of Daily Assessment and Treatment Record
                    </div>
                    <div class="panel-body">
                    <div class="form-group col-sm-3">
                        <label>Date:</label>
...
<!--Treatment Prescription ends-->
              <div class="form-group col-sm-2">
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_daily_aft_health_record.php">Add AFT DH Record</a>
                         </div>
                    </div>
			</div>
