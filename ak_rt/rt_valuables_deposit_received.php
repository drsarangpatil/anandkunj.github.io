...
<script src="js/myjs/get_rt_valuables_deposit_received.js"></script>

<title>Valuables_Deposit Received</title>
...
<body>
    ...
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_valuables_deposit_received.php", "reports/Rt_deposit_received_report.php");
            //alert (url)
            window.open(url);
        ...
        <form action="database/Rt_valuables_deposit_received.php" method="post"  enctype="multipart/form-data">
           <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Valuables-Deposit Received </b></h4>
...
<!-- Attendant Information end ================================================== -->
                    ...
                    <div class="form-group col-sm-3">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_valuables_deposit_received_up.php">Edit Deposit Received</a>
                         </div>
                    </div>
				</div>
