...
<title>RT Admission Rescheduling, Completion</title>
 ...
 <!-- JS Script for Print====================== -->   
    <script>    
        function printRepo_a()
        {
            url ="";
            url=document.URL;
            url=url.replace("rt_appointment_up.php", "reports/Rt_appointment_register.php");
            //alert (url)
            window.open(url);
    ...
    <form action="database/Rt_appointment_up.php" method="post">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4><b>RT Admission Rescheduling and Completion</b></h4>
...
<!--RT Booking  Info ends========================================= -->
                    ...
                    <div class="form-group col-sm-4">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="rt_appointment.php">Add New RT Booking</a>
                         </div>
                    </div>
			     </div>
