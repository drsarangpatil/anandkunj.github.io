...
{	
    ...
    $.ajax
        (
            {
                url: 'database/ajax/Get_rt_room_allocation_up.php',
                type: 'GET',				
                                                ...
                                                (
                                                    {
                                                        url: 'database/ajax/Get_rt_room_allocation_up.php',
                                                        type: 'GET',				
                                                        data: { process: "getRt_room_allocation_record", rt_case_sheet_id:response[0]},
                                                        
                                                        success: function (data) 
                                                        {
                                                           //alert("Success 3: " + data);

                                                           $("#Rt_room_allocation_record").html(data);
            ...
            (
                {
                    ...
                    success: function (data) 
                    {
                        ...
                        $("#rt_room_allocation_id").val(res[0]);
                        $("#p_type").val(res[1]);
                        $("#building_name").val(res[2]);
                        
                        $('#building_name').trigger('change');
                        $("#room_numbera").val(res[3]);
                        
                        //$("#room_number").val(res[3]);
                        $("#bed_number").val(res[4]);
                        $("#room_status").val(res[5]);
                        $("#no_attendant").val(res[6]);
                        $("#attendant_name1").val(res[7]);
                        $("#bed_number1").val(res[8]);
                        $("#attendant_name2").val(res[9]);
                        $("#bed_number2").val(res[10]);// to set fetched data
