...
{	
    ...
    (
        {
            url: 'database/ajax/Get_rt_daily_medicine_prescription_up.php',	// call page for data to be retrived
...
( 
    function() 
    {
        ...
        (
            {
                url: 'database/ajax/Get_rt_daily_medicine_prescription_up.php',
                type: 'GET',							
            ...
            (
                {
                    url: 'database/ajax/Get_rt_daily_medicine_prescription_up.php',// call page for data to be retrived
                    type: 'GET',							// to get data in backgrouond
                    data: { process: "getSelected_rt_medicine_records", rt_case_sheet_id:rt_case_sheet_id, daily_date:daily_date},
