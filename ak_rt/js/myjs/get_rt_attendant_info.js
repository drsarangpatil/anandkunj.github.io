...
{	
    ...
    (
        {
            url: 'database/ajax/Get_rt_attendant_info.php',	// call page for data to be retrived
...
( 
    function() 
    {
        ...
        (
            {
                url: 'database/ajax/Get_rt_attendant_info.php',
                type: 'GET',							
                                                ...
                                                (
                                                    {
                                                        ...
                                                        success: function (data) 
                                                        {
                                                            ...
                                                            $("#rt_attendant_info_id").val(res[0]);
                                                            $("#no_attendant").val(res[1]);  
                                                            $("#attendant_name1").val(res[2]);
                                                            $("#mobile_no1").val(res[3]);
                                                            $("#relation1").val(res[4]);
                                                            $("#attendant_name2").val(res[5]);
                                                            $("#mobile_no2").val(res[6]);
                                                            $("#relation2").val(res[7]);
