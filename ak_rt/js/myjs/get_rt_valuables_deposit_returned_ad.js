...
{	
    ...
    (
        {
            url: 'database/ajax/Get_rt_valuables_deposit_returned_ad.php',	// call page for data to be retrived
...
( 
    function() 
    {
        ...
        (
            {
                url: 'database/ajax/Get_rt_valuables_deposit_returned_ad.php',
                type: 'GET',							
                                                    ...
                                                    (
                                                        {
                                                            url: 'database/ajax/Get_rt_valuables_deposit_returned_ad.php',// call page for data to be retrived
                                                            type: 'GET',	// to get data in backgrouond
                                                            data: { process: "getAll_deposit_returned_records", rt_case_sheet_id:response[0]},	
    ...
    function myshow()
        {
            var rt_v_d_returned_id = $('#rt_v_d_returned_id').val();
            ...
            (
                {
                    url: 'database/ajax/Get_rt_valuables_deposit_returned_ad.php',
                    type: 'GET',							
                    data: { process: "getSelected_deposit_returned_data", rt_v_d_returned_id:rt_v_d_returned_id },
                    ...
                    success: function (data) 
                    {
                        ...
                        $("#rt_v_d_received_id").val(res[0]);
                        $("#deposit_amount").val(res[1]);  // to set fetched data
                        $("#v_items").val(res[2]);
                    },
                    error:function (data) 
                    {
