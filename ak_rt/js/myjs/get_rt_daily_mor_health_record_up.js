...
{	
    ...
    (
        {
            url: 'database/ajax/Get_rt_daily_mor_health_record_up.php',	// call page for data to be retrived
...
( 
    function() 
    {
        ...
        (
            {
                url: 'database/ajax/Get_rt_daily_mor_health_record_up.php',
                type: 'GET',							
            ...
            (
                {
                    url: 'database/ajax/Get_rt_daily_mor_health_record_up.php',// call page for data to be retrived
                    type: 'GET',							// to get data in backgrouond
                    data: { process: "getSelected_rt_diet_records", rt_case_sheet_id:rt_case_sheet_id, daily_date:daily_date},
                    // what exactly we have retrive other details
