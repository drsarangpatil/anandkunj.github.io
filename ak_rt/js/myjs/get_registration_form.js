                        ...
                        (
                            {
                                ...
                                success: function (data) 
                                {
                                    ...
                                    $("#photo").attr("src", "../ak_com/database/photos/"+res[11]);
                                    /*$("#photo").val(res[11]);*/
                                    $("#address").val(res[12]);
                                    $("#at_post").val(res[13]);
                                    $("#pin_code").val(res[14]);
                               ...
                               /*     alert("before setTimeout");
                                    ...
                                    $("#passport_doc").attr("src", "database/passport_doc/"+res[20]);
                                    /*$("#passport_doc").val(res[20]);*/
                                    $("#residence_phone").val(res[21]);
                                    $("#mobile_no").val(res[22]);
                                    $("#emergency_no").val(res[23]);
                                    $("#whatsapp_no").val(res[24]);
                                    $("#email").val(res[25]);
                                    $("#reference").val(res[26]);
                                    $("#person_category").val(res[27]);
                                    $("#user_id").val(res[28]);
