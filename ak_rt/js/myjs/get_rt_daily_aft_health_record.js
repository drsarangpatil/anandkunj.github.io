...
{	
    ...
    (
        {
            url: 'database/ajax/Get_rt_daily_aft_health_record.php',	// call page for data to be retrived
...
( 
    function() 
    {
        ...
        (
            {
                url: 'database/ajax/Get_rt_daily_aft_health_record.php',
                type: 'GET',							
                                                ...
                                                (
                                                    {
                                                        url: 'database/ajax/Get_rt_daily_aft_health_record.php',
                                                        type: 'GET',				
                                                        data: { process: "getRt_daily_health_assessment_records", rt_case_sheet_id:response[0]},

                                                        success: function (data) 
                                                        {
                                                           //alert("Success 3: " + data);

                                                           $("#all_rt_daily_health_assessment_records").html(data);
