...
{	
 ...
 $.ajax
    (
        {
            url: 'database/ajax/Get_rt_followup_prescription.php', // call page for data to be retrived
...
( 
    function() 
    {
        ...
        (
            {
                url: 'database/ajax/Get_rt_followup_prescription.php',
                type: 'GET',							
                                    ...
                                    (
                                        {
                                            url: 'database/ajax/Get_rt_followup_prescription.php', 
                                            type: 'GET',							
                                            data: { process: "getClinical_details", rt_case_sheet_id:response[0]},
                                            ...
                                            success: function (data) 
                                            {
                                                ...
                                                $("#complaints").val(res[0]);  
                                                $("#weight").val(res[1]);
                                                $("#height").val(res[2]);
                                                $("#oe").val(res[3]);
                                                $("#investigations").val(res[4]);
                                   $.ajax
                                    (
                                        {
                                            url: 'database/ajax/Get_rt_followup_prescription.php', 
