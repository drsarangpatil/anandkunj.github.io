...
{	
    ...
    (
        {
            url: 'database/ajax/Get_rt_gate_pass_clearance.php',	// call page for data to be retrived
...
( 
    function() 
    {
        ...
        (
            {
                url: 'database/ajax/Get_rt_gate_pass_clearance.php',
                type: 'GET',							
                                                    ...
                                                    (
                                                        {
                                                            url: 'database/ajax/Get_rt_gate_pass_clearance.php', 
                                                            type: 'GET',							
                                                            data: { process: "getGatepass_record", rt_case_sheet_id:response[0]},
                                                            ...
                                                            success: function (data) 
                                                            {
                                                                ...
                                                                var res = data.split("~~"); 
                                                                $("#rt_gatepass_id").val(res[0]);
                                                                $("#gatepass_date").val(res[1]);  
                                                                $("#schedule").val(res[2]);
                                                                $("#acc_d_clear").val(res[3]);
                                                                $("#hk_d_clear").val(res[4]);
                                                                $("#shop_clear").val(res[5]);
                                                                $("#sub_clear").val(res[6]);
                                                                $("#mem_clear").val(res[7]);
                                                                $("#lib_clear").val(res[8]);
                                                                $("#v_t_clear").val(res[9]);
                                                                $("#off_clear").val(res[10]);
