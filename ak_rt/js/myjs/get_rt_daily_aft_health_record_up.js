...
{	
    ...
    (
        {
            url: 'database/ajax/Get_rt_daily_aft_health_record_up.php',	// call page for data to be retrived
...
( 
    function() 
    {
        ...
        (
            {
                url: 'database/ajax/Get_rt_daily_aft_health_record_up.php',
                type: 'GET',							
                                                ...
                                                (
                                                    {
                                                        ...
                                                        success: function (data) 
                                                        {
                                                           ...
                                                           $("#all_rt_daily_aft_health_records").html(data);
            ...
            (
                {
                    url: 'database/ajax/Get_rt_daily_aft_health_record_up.php',// call page for data to be retrived
                    type: 'GET',							     // to get data in backgrouond
                    data: { process: "getSelected_daily_health_records", rt_case_sheet_id:rt_case_sheet_id, daily_date:daily_date},	
                    ...
                    success: function (data) 
                    {
                        ...
                        $("#retreat_day").val(res[0]);
                        $("#daily_date").val(res[1]);
                        $("#schedule").val(res[2]);
                        $("#weight").val(res[3]);
                        ...
                        $("#oe").val(res[10]);
                        $("#diet_status").val(res[11]);
                        $("#daily_medicine").val(res[12]);
            ...
            (
                {
                    url: 'database/ajax/Get_rt_daily_aft_health_record_up.php', // call page for data to be retrived
                    type: 'GET',							// to get data in backgrouond
                    data: { process: "getSelected_rt_treatment_records", rt_case_sheet_id:rt_case_sheet_id, daily_date:daily_date},	
