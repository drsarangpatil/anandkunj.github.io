$(document).ready
        (
            ...
            {	
                ...
                (
                    {
                        url: 'database/ajax/Get_do_donation_form_up.php',	// call page for data to be retrived
                                    ...
                                    (
                                        {
                                            url: 'database/ajax/Get_do_donation_form_up.php',// call page for data to be retrived
                                            type: 'GET',	// to get data in backgrouond
                                            data: { process: "getAll_donation_records", person_id:res[0]},	

                                            success: function (data) 
                                            {
                                               //alert("Success 3: " + data);

                                               $("#old_donation_records_list").html(data);   
 ...
 function myshow()
        {
            var do_donation_id = $('#do_donation_id').val();
            
            //alert(do_donation_id);
            $.ajax
            (
                {
                    url: 'database/ajax/Get_do_donation_form_up.php',
                    type: 'GET',							
                    data: { process: "getSelected_donation_data", do_donation_id:do_donation_id },
                    ...
                    success: function (data) 
                    {
                       ...
                       // alert("Success : " + data); 
                        ...
                        $("#do_payment_date").val(res[0]);
                        $("#donation_paid").val(res[1]);
                        $("#donation_towards").val(res[2]);
                        $("#payment_mode").val(res[3]);
                        $("#payment_details").val(res[4]);
                        $("#pan_number").val(res[5]);
                        $("#pan_name").val(res[6]);
                    },
                    error:function (data) 
                    {
