...
<body>
        ...
        <form action="database/Do_donation_form.php" method="post">
              <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h4><b>Donation Form </b></h4>
...
<!--Donation Payment Details  Pannel ends-->   
                    ...
                    <div class="form-group col-sm-2">
                        <div class="form-group" >
                            <a class="btn btn-info pull-right" href="do_donation_form_up.php">Edit Donation Form</a>
                         </div>
                    </div>
				</div>
