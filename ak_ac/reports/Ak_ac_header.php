    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../index.php"> ANANDKUNJ - Accounts</a>
        </div>
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <img class="img-circle" width="40" height="50" src="../../ak_com/assets/database/photos/<?php echo $_SESSION['user_photo'];?>"> 
                </li>  
            </ul> 
            <ul class="nav navbar-nav navbar-right">
                <li class="active">
                ...
                <li>
                    <a href="../do_donation_form.php">Donations</a>
                </li>
              
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Bills <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../../ak_op/op_billing.php">OP Bills</a></li>
                        <li><a href="../../ak_rt/rt_billing.php">RT Bills</a></li>
                        <li><a href="../../ak_stu/st_billing.php">ST Bills</a></li>
                    </ul>
                </li>  
               <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Payments <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../../ak_op/op_payment.php">OP Payments</a></li>
                        <li><a href="../../ak_rt/rt_payment.php">RT Payments</a></li>
                        <li><a href="../../ak_stu/st_payment.php">ST Payments</a></li>
                        <li><a href="../../ak_sb/sb_payment.php">SB Payments</a></li>
                        <li><a href="../../ak_mb/mb_payment.php">MB Payments</a></li>
                    </ul>
                </li> 
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Update <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="do_donation_form_up.php">Update Donations</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="../../ak_op/op_billing_up.php">OP Bills</a></li>
                        <li><a href="../../ak_rt/rt_billing_up.php">RT Bills</a></li>
                        <li><a href="../../ak_stu/st_billing_up.php">ST Bills</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="../../ak_op/op_payment_ad.php">OP Payments</a></li>
                        <li><a href="../../ak_rt/rt_payment_ad.php">RT Payments</a></li>
                        <li><a href="../../ak_stu/st_payment_ad.php">ST Payments</a></li>
                        <li><a href="../../ak_sb/sb_payment.php">SB Payments</a></li>
                        <li><a href="../../ak_mb/mb_payment.php">MB Payments</a></li>
                    </ul>
              </li>
              <li class="dropdown">
                   <a class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
                     <ul class="dropdown-menu">
                        <li><a href="../reports/Do_donation_register.php">Donation Register</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="../../ak_op/reports/Op_billing_report.php">OP Bill Register</a></li>
                        <li><a href="../../ak_rt/reports/Rt_billing_report.php">RT Bill Register</a></li>
                        <li><a href="../../ak_stu/reports/Stu_billing_report.php">ST Bill Register</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="../../ak_op/reports/Op_payment_report.php">OP Payment Register</a></li>
                        <li><a href="../../ak_rt/reports/Rt_payment_report.php">RT Payment Register</a></li>
                        <li><a href="../../ak_stu/reports/Stu_payment_report.php">ST Payment Register</a></li>
                        <li><a href="../../ak_sb/reports/Sb_all_payment_report.php">SB Payment Register</a></li>
                        <li><a href="../../ak_mb/reports/Mb_all_payment_report.php">MB Payment Register</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
