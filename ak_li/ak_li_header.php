    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> ANANDKUNJ - Library</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#">Book Return/Renew</a></li>
                        <li><a href="#">Book Stock</a></li>
                        <li><a href="#">Lost Book Entry</a></li>
                        <li><a href="#">Book Donation</a></li>
                        <li><a href="#">OPAC</a></li>
               ...
               <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#">Barcode Printing</a></li>
                        <li><a href="#">Book Details</a></li>
                        <li><a href="#">Book Issue Register</a></li>
                        <li><a href="#">Book Stock Details</a></li>
                        <li><a href="#">Donated Books</a></li>
                        <li><a href="#">Lost Book Register</a></li>
                        <li><a href="#">Fine Collected Amount</a></li>
                    </ul>
              </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#">Book Type Master</a></li>
                        <li><a href="#">Book Master</a></li>
                        <li><a href="#">Fees Master</a></li>
                        <li><a href="#">Fine Master</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
