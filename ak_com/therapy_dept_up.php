...
<?php
	...
	$con = mysqli_connect($data->host, $data->user,$data->password,$data->db);
        ...
        $Pagequery="SELECT * FROM ak_therapy_dept";
        ...
        $Readquery="SELECT * FROM ak_therapy_dept LIMIT $start, $perpage";
...
<title>Update Therapy Department</title>
</head>
<body>
<form action="database/Therapy_dept_up.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
           <h4><b>Update Therapy Department</b></h4>
            ...
            <div class="panel-group">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading">
                        All Therapy Department Records 
                    </div>
                    <div class="panel-body">
                        ...
                        <?php
                           ...
                           ?> 
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo $row['therapy_dept_id']; ?>
                                        <input type="hidden" 
                                                name="therapy_dept_id<?php echo $i; ?>" 
                                                value="<?php echo $row['therapy_dept_id']; ?>"/>
...
<!-- Fetched Address Records Pannel Ends ===================================== -->
        <div class="form-group col-sm-8">
            <div class="form-group" >
                ...
                <a class="btn btn-info" href="therapy_dept.php">Add Therapy Department</a>
             </div>
        </div>
        </div>
