...
<title>Add Disease Category</title>
</head>
<body>
<form action="database/Disease_category.php" method="post">
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       <h4><b>Add Disease Category</b></h4>
<!-- Form Information ================================================== -->
    <div class="panel-group">
        <div class="panel panel-primary">
        <div class="panel-heading"> Add Disease Category</div>
               ...
               <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" 
                               ...
                               placeholder="Respiratory/ Cardiovascular/ Digestive">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Form Information Pannel Ends================================= -->
      <div class="panel-body">
        ...
        <div class="form-group col-sm-2">
            <div class="form-group" >
                <a class="btn btn-info pull-right" href="disease_category_up.php">Edit Disease Category</a>
             </div>
            </div>                
        </div>
