...
<?php
	...
	$con = mysqli_connect($data->host, $data->user,$data->password,$data->db);
        ...
        $Pagequery="SELECT * FROM ak_districts";
        ...
        $Readquery="SELECT * FROM ak_districts LIMIT $start, $perpage";
...
<title>Update District Names</title>
</head>
<body>
<form action="database/District_up.php" method="post">
     <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
           <h4><b>Update District Names </b></h4>
                    ...
                    <div class="panel-body">
                        ...
                        <?php
                            ...
                            <tbody id="old_case_paper_list">
                                <tr>
                                    <td><?php echo $row['district_id']; ?>
                                        <input type="hidden" 
                                                name="district_id<?php echo $i; ?>" 
...
<!-- Fetched Address Records Pannel Ends ======================================= -->
        <div class="form-group col-sm-8">
            <div class="form-group" >
                ...
                <a class="btn btn-info" href="district.php">Add District</a>
             </div>
        </div>
    </div>
