...
<title>Update Diet Name</title>
</head>
<body>
<form action="database/Diet_name_up.php" method="post">
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
           <h4><b>Update Diet Name</b></h4>
                    ...
                    <div class="panel-body">
                        ...
                        <?php
                           ...
                           ?> 
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo $row['diet_name_id']; ?>
                                        <input type="hidden" 
                                                name="diet_name_id<?php echo $i; ?>" 
                                                value="<?php echo $row['diet_name_id']; ?>"/>
                                    </td> <!--this is unique id hence non-editable and sending here as hidden-->
                                    <td> <input type="text"  
                                                name="diet_name<?php echo $i; ?>" 
                                                value="<?php echo $row['diet_name']; ?>"/> 
                                    </td>
                                </tr>
                            </tbody>
                            <?php
...
<!-- Fetched Address Records Pannel Ends =================================== -->
        <div class="form-group col-sm-8">
            <div class="form-group" >
                ...
                <a class="btn btn-info" href="diet_name.php">Add Diet Name</a>
             </div>
        </div>        
    </div>
