...
<?php
	...
	$con = mysqli_connect($data->host, $data->user,$data->password,$data->db);
        ...
        $Pagequery="SELECT * FROM ak_retreat_name";
        ...
        $Readquery="SELECT * FROM ak_retreat_name LIMIT $start, $perpage";
...
<form action="database/Retreat_name_up.php" method="post">
                    ...
                    <div class="panel-body">
                        ...
                        <?php
                           ...
                           ?> 
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo $row['retreat_name_id']; ?>
                                        <input type="hidden" 
                                                name="retreat_name_id<?php echo $i; ?>" 
                                                value="<?php echo $row['retreat_name_id']; ?>"/>
                                    </td> <!--this is unique id hence non-editable and sending here as hidden-->
                                    <td> <input type="text"  size="75"
                                                name="retreat_name<?php echo $i; ?>" 
                                                value="<?php echo $row['retreat_name']; ?>"/> 
                                    </td>
                                </tr>
                            </tbody>
                            <?php
...
<!-- Fetched Address Records Pannel Ends ==================================== -->
        <div class="form-group col-sm-8">
            <div class="form-group" >
                ...
                <a class="btn btn-info" href="retreat_name.php">Add Retreat Name</a>
             </div>
        </div>
        </div>
