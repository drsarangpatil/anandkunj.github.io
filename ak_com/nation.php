...
<body>
    <form action="database/Nation.php" method="post">
           <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
               <h4><b>Nation Name</b></h4>
<!-- Form Information ================================================== -->
...
<!-- Form Information Pannel Ends================================= -->
          <div class="panel-body">
            ...
            <div class="form-group col-sm-2">
                <div class="form-group" >
                    <a class="btn btn-info pull-right" href="nation_up.php">Edit Nation Names</a>
                 </div>
                </div>                
            </div>
<!-- Table Pannel starts================================= -->     
<div class="panel-group">
    <div class="panel panel-primary">
        <div class="panel-body">
            <h4 align="left"><b> List of District Names </b> </h4>
