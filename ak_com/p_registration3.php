                             ...
                             <div class="form-group col-sm-9">
                                ...
                                <div style="font-size:14px" class="form-group">
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="cp[]" id="participant" value="Participant">Participant
                                    </label>
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="cp[]" id="patient" value="Patient">Patient
                                    </label>
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="cp[]" id="student" value="Student">Student
                                    </label>
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="cp[]" id="employee" value="Employee">Employee
                                    </label> 
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="cp[]" id="subscriber" value="Subscriber">Subscriber
                                    </label> 
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="cp[]" id="member" value="Member">Member
                                    </label>
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="cp[]" id="donner" value="Donner">Donner
                                    </label>
                                <!--<select class="form-control" 
