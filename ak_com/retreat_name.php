...
<title>Add Retreat Name</title>
</head>
<body>
<form action="database/Retreat_name.php" method="post">
...
<!-- Form Information Pannel Ends================================= -->
      <div class="panel-body">
        ...
        <div class="form-group col-sm-2">
            <div class="form-group" >
                <a class="btn btn-info pull-right" href="retreat_name_up.php">Edit Retreat Names</a>
             </div>
            </div>                
        </div> 
<!-- Table Pannel starts================================= -->     
<div class="panel-group">
    <div class="panel panel-primary">
        <div class="panel-body">
            <h4 align="left"><b> List of Retreat Names </b> </h4>
