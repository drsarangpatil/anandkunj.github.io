...
<?php
	...
	$con = mysqli_connect($data->host, $data->user,$data->password,$data->db);
        ...
        $Pagequery="SELECT * FROM ak_nation";
        ...
        $Readquery="SELECT * FROM ak_nation LIMIT $start, $perpage";
...
<title>Update Nation Names</title>
</head>
<body>

<form action="database/Nation_up.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
           <h4><b>Update Nation Names</b></h4>
                    ...
                    <div class="panel-body">
                        ...
                        <?php
                           ...
                           ?> 
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo $row['nation_id']; ?>
                                        <input type="hidden" 
                                        name="nation_id<?php echo $i; ?>" 
                                        value="<?php echo $row['nation_id']; ?>"/>
...
<!-- Fetched Address Records Pannel Ends =========================================== -->
        <div class="form-group col-sm-8">
            <div class="form-group" >
                ...
                <a class="btn btn-info" href="nation.php">Add Nation</a>
             </div>
        </div>
</div>
