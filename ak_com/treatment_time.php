...
<title>Add Treatment Time</title>
</head>
<body>
    <form action="database/Treatment_time.php" method="post">
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
               <h4><b>Add Treatment Time</b></h4>
...
<!-- Form Information Pannel Ends================================= -->
          <div class="panel-body">
            ...
            <div class="form-group col-sm-2">
                <div class="form-group" >
                    <a class="btn btn-info pull-right" href="treatment_time_up.php">Edit Treatment Time</a>
                 </div>
                </div>                
            </div>
<!-- Table Pannel starts================================= -->     
