...
<title>Add Disease Nick</title>
</head>
<body>
<form action="database/Disease_nick.php" method="post">
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
           <h4><b>Add Disease Nick </b></h4>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" 
                               ...
                               placeholder="Disease Short Name">
                    </div>
                </div>
            </div>
            </div>
...
<!-- Form Information Pannel Ends================================= -->
      <div class="panel-body">
        ...
        <div class="form-group col-sm-2">
            <div class="form-group" >
                <a class="btn btn-info pull-right" href="disease_nick_up.php">Edit Nick Name</a>
             </div>
            </div>                
        </div> 
<!-- Table Pannel starts================================= -->     
<div class="panel-group">
    <div class="panel panel-primary">
        <div class="panel-body">
            <h4 align="left"><b> List of Disease Names </b> </h4>
