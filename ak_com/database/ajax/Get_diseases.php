<?php
	...
	if ($con)
	{
        ...
        if($process === "getDisease_nick")
		{
			$disease_category=filter_input(INPUT_GET, 'disease_category');
			$disease_name=filter_input(INPUT_GET, 'disease_name');
			//echo "8";
			$query = ("SELECT disease_nick_id, disease_nick FROM ak_disease_nick where disease_category = '" . $disease_category . "' AND disease_name = '" . $disease_name . "'");
