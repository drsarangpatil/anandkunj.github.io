<?php
	...
	if ($con)
	{
		...
		{
			//create query
			$query="INSERT INTO ak_life_style_instructions (disease_category, language, life_style_instructions) VALUES ('". $_POST["disease_category"]."', '". $_POST["language"]."', '". $_POST["life_style_instructions"]."')";
			//echo $query;
