...
<script src="./assets/js/myjs/get_treatment_details.js"></script>
<title>Add Treatment Name</title>
</head>
<body>
<form action="database/Disease_name.php" method="post">
     <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
           <h4><b>Add Treatment Name </b></h4>
 ...
 <!-- Form Information Pannel Ends================================= -->
          <div class="panel-body">
            ...
            <div class="form-group col-sm-2">
                <div class="form-group" >
                    <a class="btn btn-info pull-right" href="treatment_name_up.php">Edit Treatment Name</a>
                 </div>
                </div>                
            </div>
<!-- Table Pannel starts================================= -->     
<div class="panel-group">
    <div class="panel panel-primary">
        <div class="panel-body">
            <h4 align="left"><b> List of Treatment Names </b> </h4>
