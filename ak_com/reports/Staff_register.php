                            ...
                            <?php 
                                ...
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        $query="SELECT p.photo, p.full_name, d.staff_short_name, p.at_post, p.mobile_no, d.doj, d.qualifcation1, d.name_of_dept, d.designation, d.role, d.password FROM ak_p_registration p, ak_staff_other_info d WHERE p.person_id= d.person_id ";
                                        //echo $query;
