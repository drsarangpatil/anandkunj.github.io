    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> ANANDKUNJ - Home</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="../p_registration.php"> New Registration</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="../p_registration.php">Update Registration</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../reports/P_registration_mini_report.php">Registration Mini Register</a></li>
                        <li><a href="../reports/P_registration_report.php">Registration Register</a></li>
                        <li><a href="../reports/P_registration_card.php">Registration Card</a>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <span class="glyphicon glyphicon-cog"></span> <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../nation.php">Add Nation</a></li>
                        <li><a href="../state.php">Add State</a></li>
                        <li><a href="../district.php">Add District</a></li>
                        <li><a href="../tahsil.php">Add Tahsil</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="../nation_up.php">Update Nation</a></li>
                        <li><a href="../state_up.php">Update State</a></li>
                        <li><a href="../district_up.php">Update District</a></li>
                        <li><a href="../tahsil_up.php">Update Tahsil</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
