<html lang="en">
    <head>
        <title>Mini Person Registration Register</title>
		<meta charset="utf-8">
...
<!-- Document Header End ================================================== --> 
                  <h5 align="center"><b> Person Registration Mini Register</b></h5>	
...
<!-- Php code for P Registration Table Ends =============================== -->
				    ...
				    <!--<td><a href="../P_registration_mini_report.php">Back</a></td>-->
				</div>
                </div>
            <div class="container col-sm-1">
            </div>
