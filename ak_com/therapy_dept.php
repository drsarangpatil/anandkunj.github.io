...
<title>Add Therapy Department</title>
</head>
<body>
    <form action="database/Therapy_dept.php" method="post">
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
               <h4><b>Add Therapy Department</b></h4>
                   ...
                   <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" 
                                   ...
                                   placeholder="Massage Therapy/ Hydrotherapy/ Mud-therapy">
                        </div>
                    </div>
                </div>
                </div>
...
<!-- Form Information Pannel Ends================================= -->
          <div class="panel-body">
            ...
            <div class="form-group col-sm-2">
                <div class="form-group" >
                    <a class="btn btn-info pull-right" href="therapy_dept_up.php">Edit Therapy Dept</a>
                 </div>
                </div>                
            </div>
<!-- Table Pannel starts================================= -->     
<div class="panel-group">
    <div class="panel panel-primary">
        <div class="panel-body">
            <h4 align="left"><b> List of Therapy Department </b> </h4>
